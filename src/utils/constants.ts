...
export const enum templateAudio {
 dragAndDrop = 'instruction.dragAndDrop',
  ...
  substractionWithImage = 'instruction.substractionWithImage',
    substractionWithoutImage='instruction.substractionWithoutImage',
    numberIdentificationWithImage= 'instruction.numberIdentificationWithImage',
    numberIdentificationWithoutImage= 'instruction.numberIdentificationWithoutImage',
    wordBuildingWithImage= 'instruction.wordBuildingWithImage',
    wordBuildingWithoutImage= 'instruction.wordBuildingWithoutImage',
    pictureClues='instruction.pictureClues',
    pictureWordMatchMultipleImages='instruction.pictureWordMatchMultipleImages',
    pictureWordMatchSingleImage='instruction.pictureWordMatchSingleImage',
    sentenceMatch='instruction.sentenceMatch',
    imageMatch='instruction.imageMatch',
    palStoryTale='instruction.palStoryTale',
    palEgmaPatternMatching='instruction.palEgmaPatternMatching',
    palEgmaWordProblemDragnDrop='instruction.palEgmaWordProblemDragnDrop',
    palEgmaWordProblemClick='instruction.palEgmaWordProblemClick',
    palEgraOddOneOut='instruction.palEgraOddOneOut',
    palEgraArrangePictures='instruction.palEgraArrangePictures',
    palEgraBuildWord='instruction.palEgraBuildWord',
    palEgraWordFormation='instruction.palEgraWordFormation',
    palInventedSpelling='instruction.palInventedSpelling',
    palLetterIdentification='instruction.palLetterIdentification',
    palStoryMaking='instruction.palStoryMaking',
    palegmasumtogether='instruction.palegmasumtogether',
    palegmamultioption='instruction.palegmamultioption',
    palegraoptionaudio='instruction.palegraoptionaudio',
    palegrawordmatch='instruction.palegrawordmatch',
    palegramcqimages='instruction.palegramcqimages'
}