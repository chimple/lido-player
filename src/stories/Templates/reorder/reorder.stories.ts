...
function getContainerXml(args) {
 ...
 <lido-container visible="true" objective="${args.correctObjective.toLowerCase()}" is-continue-on-correct="true" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/phonic-tractor/bg-image.png" onCorrect="lido-avatar.avatarAnimate='Success'; this.sleep='2000';" onEntry="this.sleep='1000'; this.slideAnimation='true';">
	...
	<lido-cell visible="true" layout="col" width="100%" height="100%" bg-color="transparent">
		...
		<!-- Question -->
		<lido-text tab-index="1" show-speak-icon="true" visible="true" y="landscape.33px,portrait.0px" width="landscape.70%, portrait.62%" height="10%" string="${args.question}" audio="${args.questionAudio}" font-size="36px" onEntry=" this.padding='0px 45px';this.fontWeight='600'; " bg-color="transparent"></lido-text>
