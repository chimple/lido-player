...
function getContainerXml(args) {
  return `<main>	
  <lido-container id="lido-container" is-allow-only-correct="true" objective="${args.drop1},${args.drop2},${args.drop3}" visible="true" bg-image="https://drive.google.com/file/d/1xxQuL4aniTKgzFsUm680kLrpin4bxs1-/view" dropAttr="EnableAnimation">
				<!-- Chimple Avatar -->
