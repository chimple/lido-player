...
function getContainerXml(args){
	return `
    <main>
	<lido-container id="lido-container" tabIndex="1" shouldAppend="true" value="mainContainer1" bgImage="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/phonic-tractor/bgImg.png"  bgColor="transparent" objective="${args.answer1},${args.answer2},${args.answer3}" height="100%" width="100%" visible="true" showCheck="false" isContinueOnCorrect="true" afterDrop="false" onCorrect="lido-avatar.avatarAnimate='Success';this.sleep='1000'; img1.speak='true'; b1.animation='placeToLeft 2s linear' ;  this.sleep='2000';" onEntry="this.justifyContent='space-around'; "  onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';"   > 
	    <!-- Chimple Avatar -->
		...
		<lido-cell layout="col" visible="true" width="100%" height="100%"  bgColor="transparent" margin="landscape.-38px 0px -122px 0px, portrait.0px 0px 0px 0px">
			...
			<lido-image visible="true" id="img1" height="140px" width="361px"  disableEdit="true" isSlice="true" bgColor="transparent" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/phonic-tractor/board.png" margin="landscape.42px 0px -126px 0px, portrait.-58px 0px 60px 0px" >
				<lido-text id="heading"  tabIndex="2" height="100px"  visible="true" string="${args.text1}" font="'Baloo Bhai 2'" fontColor="white" font-size="landscape.96px, portrait.96px" bgColor="transparent" onEntry="  this.fontWeight='600';"   margin="landscape.0px 0px 0px 0px, portrait.0px 0px 0px 0px" >
				</lido-text>
			</lido-image>
			<!-- tractor -->
			<lido-cell layout="row" id="b1" visible="true" width="landscape.80%, portrait.849px" height="landscape.303px, portrait.30%" bgColor="transparent" onEntry=" alignItems='center';this.animation='rightToPlace 3s linear';" margin="landscape.200px 0px 60px 0px, portrait.192px -366px -318px -366px" >
				...
				<lido-cell height="237px" width="200px" visible="true" bgColor="transparent" layout="col" margin="landscape.68px 97px 0px -41px, portrait.0px -142px 0px 151px">
					<lido-text id="t1" type="drop" tabIndex="1" bgColor="transparent" height="132px" width="132px" value="${args.answer1}" isAllowOnlyOneDrop="true" margin="-25px 0px 16px 0px" onEntry="this.border='5px dashed #f34d08 '; this.borderRadius='6px';"></lido-text>
				...
				<!-- drop and trolley -->
					<lido-cell height="237px" width="200px" visible="true" bgColor="transparent" layout="col" margin="landscape.68px 171px 0px -171px, portrait.0px 0px 0px 0px">
						<lido-text id="t2" type="drop" bgColor="transparent" tabIndex="2" height="132px" width="132px" value="${args.answer2}" isAllowOnlyOneDrop="true"  margin="landscape.-25px 0px 16px 0px, portrait.-25px 0px 16px 180px"  onEntry="this.border='5px dashed #f34d08 '; this.borderRadius='6px';"></lido-text>
				...
				<!-- drop and trolley -->
					<lido-cell height="237px" width="200px" visible="true" bgColor="transparent" layout="col" margin="landscape.68px 254px 0px -245px, portrait.0px -41px 0px 36px">
						<lido-text id="t3" type="drop" bgColor="transparent" tabIndex="3" height="132px" width="132px" value="${args.answer3}" isAllowOnlyOneDrop="true"  margin="-25px 0px 16px 0px"  onEntry="this.border='5px dashed #f34d08 '; this.borderRadius='6px';"></lido-text>
			...
			<lido-cell layout="wrap" width="80%" height="150px" visible="true" bgColor="transparent" margin="landscape.-143px -701px 251px 0px, portrait.36px -102px -25px 0px">
				<lido-text id="option1" width="132px"  height="132px" value="${args.option1}"  visible="true" string="${args.option1}" font="'Baloo Bhai 2'" fontColor="white" type="drag" font-size="landscape.96px, portrait.96px" bgColor="transparent" onEntry="  this.fontWeight='600';this.boxShadow= 0 6px 0px rgba(0, 0, 0, 0.1)';"  margin="landscape.150px 0px 112px 0px, portrait.0px 0px 0px 0px"  borderImage="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/phonic-tractor/box.png" onTouch="this.speak='true';"  >
				</lido-text>
				<lido-text id="option2"   height="132px" width="132px" visible="true" value="${args.option2}" string="${args.option2}" font="'Baloo Bhai 2'" fontColor="white" type="drag" font-size="landscape.96px, portrait.96px" bgColor="transparent" onEntry="  this.fontWeight='600';this.boxShadow= 0 6px 0px rgba(0, 0, 0, 0.1)';"   margin="landscape.150px 0px 112px 0px, portrait.0px 0px 0px 0px" borderImage="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/phonic-tractor/box.png" onTouch="this.speak='true';" >
				</lido-text>
				<lido-text id="option3"  height="132px" width="132px" visible="true" value="${args.option3}" string="${args.option3}" font="'Baloo Bhai 2'" fontColor="white" type="drag" font-size="landscape.96px, portrait.96px" bgColor="transparent" onEntry="  this.fontWeight='600';this.boxShadow= 0 6px 0px rgba(0, 0, 0, 0.1)';"   margin="landscape.150px 0px 112px 0px, portrait.0px 0px 0px 0px" borderImage="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/phonic-tractor/box.png" onTouch="this.speak='true'; this.sleep='100';" >
				</lido-text>
