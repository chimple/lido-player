...
function getContainerXml(args) {
  return `<main>
<lido-container visible="true" objective="${args.answers}" is-continue-on-correct="true" bg-image="https://drive.google.com/file/d/1Fx01HoHGMaVxxoaaIM3IwG14_A9AO7ZQ/view" onCorrect="lido-avatar.avatarAnimate='Success'; this.sleep='2000';" onEntry="this.sleep='1000'; this.slideAnimation='true';">
