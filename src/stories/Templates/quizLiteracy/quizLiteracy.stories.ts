...
function getContainerXml(args) {
  ...
  : ''}
		...
		<lido-cell layout="landscape.wrap,portrait.col" visible="true"  margin="landscape.0px,portrait.0px 0px 0px 0px" width="landscape.88%,portrait.77%" height="216px" bg-Color="transparent" onEntry="this.gridTemplateColumns = 'repeat(2, 1fr)';  this.gridTemplateRows = 'repeat(2, 1fr)';this.align-items='center'; this.justify-content='center'; this.gap='40px';">
            ...
            <lido-text visible="true" audio="" onCorrect="this.border='5px solid green';this.cellBorderAnimate='#65BC46';" onInCorrect="this.vibrate='horizontal-shake';" id="drag${tabCounter}" tab-index="${tabCounter++}" font-size="100px" border-radius="12px" font-color="black" height="205px" width="auto" string="${args.option1}" value="${args.option1}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
              <lido-text visible="true" audio="" onCorrect="this.border='5px solid green';" onInCorrect="this.vibrate='horizontal-shake';" id="drag${tabCounter}" tab-index="${tabCounter++}" font-size="100px" border-radius="12px" font-color="black" height="205px" width="auto" string="${args.option2}" value="${args.option2}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
              <lido-text visible="true" audio="" onCorrect="this.border='5px solid green';" onInCorrect="this.vibrate='horizontal-shake';"  id="drag${tabCounter}" tab-index="${tabCounter++}" font-size="100px" border-radius="12px" font-color="black" height="205px" width="auto" string="${args.option3}" value="${args.option3}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
              <lido-text visible="true" audio="" onCorrect="this.border='5px solid green';" onInCorrect="this.vibrate='horizontal-shake';"   id="drag${tabCounter}" tab-index="${tabCounter++}" font-size="100px" border-radius="12px" font-color="black" height="205px" width="auto" string="${args.option4}" value="${args.option4}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
