  ...
  return `<main>
		...
		<lido-cell bg-color="transparent" layout="landscape.col, portrait.col" width="landscape.75%, portrait.100%" height="landscape.43%, portrait.40%" onEntry="this.animation='bottomToPlace 1.5s linear';" marginTop="potrait.-10%" visible="true" alignItems="center" justifyContent="center">
			...
			<lido-cell layout="landscape.row, portrait.row" width="landscape.95%, portrait.95%" height="landscape.43%, portrait.22%" child-elements-length="7" onEntry="this.gap='28px ';    this.gridTemplateColumns = 'repeat(2, 1fr)';  this.gridTemplateRows = 'repeat(2, 1fr)';" visible="true">
				<lido-image id="option1" is-slice="true" font-family="'Baloo Bhai 2'" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/box_alphabet_spelling.png" value="${args.option1}"  tab-index="4" visible="true" type="drag" onEntry="this.boxShadow='0 5px 3px'; this.color='white'; this.fontSize='80px'; this.fontWeight='600';" width="landscape.100%, portrait.100%" height="landscape.100%, portrait.150%" margin="landscape.0px 21px 0px 0px , portrait. 0">
					<lido-text  string='${args.option1}' font-family="'Baloo Bhai 2'" fontSize='80px' onTouch="this.speak='true';" bg-color='transparent' onEntry='this.color="white"'></lido-text>
				</lido-image>
				<lido-image id="option2" is-slice="true" font-family="'Baloo Bhai 2'" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/box_alphabet_spelling.png" value="${args.option2}" tab-index="5" visible="true" type="drag" onEntry="this.boxShadow='0 5px 3px'; this.color='white'; this.fontSize='80px'; this.fontWeight='600';" width="landscape.100%, portrait.100%" height="landscape.100%, portrait.150%" margin="landscape.0px 21px 0px 0px , portrait. 0">
					<lido-text  string='${args.option2}' font-family="'Baloo Bhai 2'" fontSize='80px' onTouch="this.speak='true';" bg-color='transparent' onEntry='this.color="white"'></lido-text>
				</lido-image>
				<lido-image id="option3" is-slice="true" font-family="'Baloo Bhai 2'" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/box_alphabet_spelling.png" value="${args.option3}"  tab-index="6" visible="true" type="drag" onEntry="this.boxShadow='0 5px 3px'; this.color='white'; this.fontSize='80px'; this.fontWeight='600';" width="landscape.100%, portrait.100%" height="landscape.100%, portrait.150%" margin="landscape.0px 21px 0px 0px , portrait. 0">
					<lido-text string='${args.option3}' font-family="'Baloo Bhai 2'" fontSize='80px' onTouch="this.speak='true';" bg-color='transparent' onEntry='this.color="white"'></lido-text>
				</lido-image>
				<lido-image id="option4" is-slice="true" font-family="'Baloo Bhai 2'" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/box_alphabet_spelling.png" value="${args.option4}" tab-index="7" visible="true" type="drag" onEntry="this.boxShadow='0 5px 3px'; this.color='white'; this.fontSize='80px'; this.fontWeight='600';" width="landscape.100%, portrait.100%" height="landscape.100%, portrait.150%" margin="landscape.0px 21px 0px 0px , portrait. 0">
					<lido-text  string='${args.option4}' font-family="'Baloo Bhai 2'" fontSize='80px' onTouch="this.speak='true';" bg-color='transparent' onEntry='this.color="white"'></lido-text>
				</lido-image>
				<lido-image id="option5" is-slice="true" font-family="'Baloo Bhai 2'" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/box_alphabet_spelling.png" value="${args.option5}" tab-index="8	" visible="true" type="drag" onEntry="this.boxShadow='0 5px 3px'; this.color='white'; this.fontSize='80px'; this.fontWeight='600';" width="landscape.100%, portrait.100%" height="landscape.100%, portrait.150%" margin="landscape.0px 21px 0px 0px , portrait. 0">
					<lido-text string='${args.option5}' font-family="'Baloo Bhai 2'" fontSize='80px' onTouch="this.speak='true';" bg-color='transparent' onEntry='this.color="white"'></lido-text>
				</lido-image>
			</lido-cell>
		</lido-cell>
	</lido-container>
