	...
	return `<main>
		...
		<lido-cell bgColor="transparent" layout="landscape.col, portrait.col" width="landscape.75%, portrait.100%" height="landscape.43%, portrait.40%" onEntry="this.animation='bottomToPlace 1.5s linear';" marginTop="potrait.-10%" visible="true" alignItems="center" justifyContent="center">
			<lido-cell layout="landscape.row, portrait.row" width="landscape.75%, portrait.95%" height="landscape.43%, portrait.23%" childElementsLength="5" onEntry="this.gap='28px';    this.gridTemplateColumns = 'repeat(2, 1fr)';  this.gridTemplateRows = 'repeat(2, 1fr)';" visible="true">
				<lido-image id="image1" visible="true" type="drop" tabIndex='1' value="${args.correct1}" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/hole_dropbox_spelling.png" width="landscape.20%, portrait.100%" height="landscape.100%, portrait.62%" margin="landscape.0px 21px 0px 0px , portrait. 0">
				</lido-image>
				<lido-image id="image2" visible="true" type="drop" tabIndex='2' value="${args.correct2}" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/hole_dropbox_spelling.png" width="landscape.20%, portrait.100%" height="landscape.100%, portrait.62%" margin="landscape.0px 21px 0px 0px , portrait. 0">
				</lido-image>
				<lido-image id="image3" visible="true" type="drop" tabIndex='3' value="${args.correct3}" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/hole_dropbox_spelling.png" width="landscape.20%, portrait.100%" height="landscape.100%, portrait.62%" margin="landscape.0px 21px 0px 0px , portrait. 0">
				</lido-image>
			</lido-cell>
			<lido-cell layout="landscape.row, portrait.row" width="landscape.95%, portrait.95%" height="landscape.43%, portrait.22%" childElementsLength="7" onEntry="this.gap='28px ';    this.gridTemplateColumns = 'repeat(2, 1fr)';  this.gridTemplateRows = 'repeat(2, 1fr)';" visible="true">
				<lido-image id="option1" isSlice="true" font="'Baloo Bhai 2'" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/box_alphabet_spelling.png" value="${args.option1}"  tabIndex="4" visible="true" type="drag" onEntry="this.boxShadow='0 5px 3px'; this.color='white'; this.fontSize='80px'; this.fontWeight='600';" width="landscape.100%, portrait.100%" height="landscape.100%, portrait.150%" margin="landscape.0px 21px 0px 0px , portrait. 0">
					<lido-text  string='${args.option1}' font="'Baloo Bhai 2'" fontSize='80px' onTouch="this.speak='true';" bgColor='transparent' onEntry='this.color="white"'></lido-text>
				</lido-image>
				<lido-image id="option2" isSlice="true" font="'Baloo Bhai 2'" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/box_alphabet_spelling.png" value="${args.option2}" tabIndex="5" visible="true" type="drag" onEntry="this.boxShadow='0 5px 3px'; this.color='white'; this.fontSize='80px'; this.fontWeight='600';" width="landscape.100%, portrait.100%" height="landscape.100%, portrait.150%" margin="landscape.0px 21px 0px 0px , portrait. 0">
					<lido-text  string='${args.option2}' font="'Baloo Bhai 2'" fontSize='80px' onTouch="this.speak='true';" bgColor='transparent' onEntry='this.color="white"'></lido-text>
				</lido-image>
				<lido-image id="option3" isSlice="true" font="'Baloo Bhai 2'" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/box_alphabet_spelling.png" value="${args.option3}"  tabIndex="6" visible="true" type="drag" onEntry="this.boxShadow='0 5px 3px'; this.color='white'; this.fontSize='80px'; this.fontWeight='600';" width="landscape.100%, portrait.100%" height="landscape.100%, portrait.150%" margin="landscape.0px 21px 0px 0px , portrait. 0">
					<lido-text string='${args.option3}' font="'Baloo Bhai 2'" fontSize='80px' onTouch="this.speak='true';" bgColor='transparent' onEntry='this.color="white"'></lido-text>
				</lido-image>
				<lido-image id="option4" isSlice="true" font="'Baloo Bhai 2'" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/box_alphabet_spelling.png" value="${args.option4}" tabIndex="7" visible="true" type="drag" onEntry="this.boxShadow='0 5px 3px'; this.color='white'; this.fontSize='80px'; this.fontWeight='600';" width="landscape.100%, portrait.100%" height="landscape.100%, portrait.150%" margin="landscape.0px 21px 0px 0px , portrait. 0">
					<lido-text  string='${args.option4}' font="'Baloo Bhai 2'" fontSize='80px' onTouch="this.speak='true';" bgColor='transparent' onEntry='this.color="white"'></lido-text>
				</lido-image>
				<lido-image id="option5" isSlice="true" font="'Baloo Bhai 2'" src="https://media.githubusercontent.com/media/chimple/bahama/master/assets/games/spelldoor/textures/box_alphabet_spelling.png" value="${args.option5}" tabIndex="8	" visible="true" type="drag" onEntry="this.boxShadow='0 5px 3px'; this.color='white'; this.fontSize='80px'; this.fontWeight='600';" width="landscape.100%, portrait.100%" height="landscape.100%, portrait.150%" margin="landscape.0px 21px 0px 0px , portrait. 0">
					<lido-text string='${args.option5}' font="'Baloo Bhai 2'" fontSize='80px' onTouch="this.speak='true';" bgColor='transparent' onEntry='this.color="white"'></lido-text>
				</lido-image>
			</lido-cell>
		</lido-cell>
	</lido-container>
