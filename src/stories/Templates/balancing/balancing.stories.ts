...
function getContainerXml(args) {
  ...
  return `
   <main>
    <lido-container visible="true" drop-action="move"  objective="${objective}"  equationCheck="$#lefthandle1,$#righthandle1" id="lido-container" onCorrect="lido-avatar.avatarAnimate='Success';this.sleep='2000';" show-Check="true" bg-image="https://drive.google.com/file/d/1dgcgxXaZP7k0AMSEl8gjvqZt2hZEL-ve/view" is-continue-on-correct="true">
     <!-- Chimple Avatar -->
    <lido-cell layout="pos" id="pos1" disable-edit="true" value="pos2" height="landscape.396px,portrait.400px" width="landscape.298px,portrait.369px" x="landscape.82%, portrait.32%" y="landscape.63%, portrait.78%" aria-hidden="true" z="1" bg-color="transparent" visible="true" onEntry="">
      ...
      <lido-cell visible="true" height="130px" width="80%" layout="row" onEntry="this.position='relative';" y="landscape.6%,portrait.4%">
        <lido-image  is-slice="true" height="126px" width="172px" audio="" id="drag1" value="${leftValue}" tab-index="3" visible="true"  x="78%" y="0%" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/balancing/big_fruit.png" type="drag">
          <lido-text font-family="'Baloo Bhai 2'" height="126px" width="120px" audio="" margin="30px 1px 0px 0px" visible="true" onEntry="this.fontWeight='600';" string="${leftValue}" fontColor="black" font-size="40px"></lido-text>
        </lido-image>
        <lido-image is-slice="true"  height="126px" width="172px" audio="" id="drag2" value="${rightValue}" tab-index="4" visible="true"  x="78%" y="0%" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/balancing/big_fruit.png" type="drag">
          <lido-text font-family="'Baloo Bhai 2'" height="126px" width="120px" audio=""  margin="30px 1px 0px 0px" visible="true" onEntry="this.fontWeight='600';" string="${rightValue}" fontColor="black" font-size="40px"></lido-text>
        </lido-image>
      </lido-cell>
    </lido-container>
   </main>
