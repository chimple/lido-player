  ...
  <lido-text visible="false" id="inst" string="choose the correct option"></lido-text>
   ...
   <lido-cell layout="landscape.row,portrait.col" visible="true" bg-Color="transparent" width="landscape.109%,portrait.90%" height="68%" margin="landscape.40px 0px -31px 0px,portrait.-107px 0px 0px 0px">
		...
		<lido-cell layout="col" visible="true"  width="landscape.53%,portrait.108%" height="216px" bg-Color="transparent" margin="landscape.0px 0px 0px 0px,portrait.0px 0px 0px 0px" onEntry="this.align-items='center'; this.justify-content='center'; this.gap='24px';">
            <lido-text visible="true" disable-speak="true" audio="" onCorrect="" onInCorrect=""  id="option1" font-family="'Baloo Bhai 2'" tab-index="2" font-size="54px" border-radius="12px" font-color="black" height="120px" width="873px" string="${args.option1}" value="${args.option1}" type="click" onEntry="this.font-weight='500';this.padding='12px 19px';this.line-height='1';">
            </lido-text>
			<lido-text visible="true" audio="" disable-speak="true"  id="option2" onCorrect="" onInCorrect="" font-family="'Baloo Bhai 2'" tab-index="3" font-size="54px" border-radius="12px" font-color="black" height="120px" width="873px" string="${args.option2}" value="${args.option2}" type="click" onEntry="this.font-weight='500';this.padding='12px 19px';this.line-height='1';">
            </lido-text>
			<lido-text visible="true" audio="" disable-speak="true"  id="option3" font-family="'Baloo Bhai 2'" tab-index="4" font-size="54px" onCorrect="" onInCorrect="" border-radius="12px" font-color="black" height="120px" width="873px" string="${args.option3}" value="${args.option3}" type="click" onEntry="this.font-weight='500';this.padding='12px 19px'; this.line-height='1';">
            </lido-text>
			<lido-text visible="true" audio="" disable-speak="true"  id="option4" font-family="'Baloo Bhai 2'" tab-index="5" font-size="54px" border-radius="12px" font-color="black" height="120px" onCorrect="" onInCorrect="" width="873px" string="${args.option4}" value="${args.option4}" type="click" onEntry="this.font-weight='500';this.padding='12px 19px';this.line-height='1';">
            </lido-text>
		</lido-cell>
