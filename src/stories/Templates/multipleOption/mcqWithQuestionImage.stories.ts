...
function getContainerXml(args) {
  const questionImage = args.questionImg === "" ? "" : `<lido-image visible="true" bg-color="white" height="landscape.80%, portrait.35%" src="${args.questionImg}" border-radius="6px" onEntry="this.border='5px solid white';"></lido-image>`;
  return `<main>
		...
		<lido-cell visible="true" layout="col" width="100%" height="100%" bg-color="transparent">
			...
			<lido-cell visible="true" width="68%" height="landscape.68%, portrait.90%" bg-color="transparent" layout="landscape.row, portrait.col"  margin="landscape.0, portrait.-108px 0 0 0">
					...
					<lido-cell visible="true" layout="wrap" width="landscape.40%, portrait.80%" height="landscape.97%, portrait.auto" bg-color="transpernt" gap="40px" onEntry="" margin="landscape.0, portrait.-195px 0 0 0">
							...
							<lido-cell visible="true" layout="col" width="100%" type="click" audio="${args.audio1}" value="${args.option1}" height="landscape.250px, portrait.250px" onEntry="this.borderRadius='25px'; this.padding='0';" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" onTouch="this.speak='true';">
								${args.optionImg1 === "" ? "" : `<lido-image visible="true" src="${args.optionImg1}" bg-color="transparent" width="90%" height="auto" border-radius="25px 25px 0 0" onEntry="this.marginTop='10px';"></lido-image>`}
							...
							<lido-cell visible="true" layout="col" width="100%" type="click" audio="${args.audio2}" value="${args.option2}" height="landscape.250px, portrait.250px" onEntry="this.borderRadius='25px'; this.padding='0';" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" onTouch="this.speak='true';">
								${args.optionImg2 === "" ? "" : `<lido-image visible="true" src="${args.optionImg2}" bg-color="transparent" width="90%" height="auto" border-radius="25px 25px 0 0" onEntry="this.marginTop='10px';"></lido-image>`}
							...
							<lido-cell visible="true" layout="col" width="100%" type="click" audio="${args.audio3}" value="${args.option3}" height="landscape.250px, portrait.250px" onEntry="this.borderRadius='25px'; this.padding='0';" margin="landscape.0, portrait.20px 0 0 0" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" onTouch="this.speak='true';">
								${args.optionImg3 === "" ? "" : `<lido-image visible="true" src="${args.optionImg3}" bg-color="transparent" width="90%" height="auto" border-radius="25px 25px 0 0" onEntry="this.marginTop='10px';"></lido-image>`}
							...
							<lido-cell visible="true" layout="col" width="100%" type="click" audio="${args.audio4}" value="${args.option4}" height="landscape.250px, portrait.250px" onEntry="this.borderRadius='25px'; this.padding='0';" margin="landscape.0, portrait.20px 0 0 0" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" onTouch="this.speak='true';">
								${args.optionImg4 === "" ? "" : `<lido-image visible="true" string="${args.option4}" bg-color="transparent" width="90%" height="auto" border-radius="25px 25px 0 0" onEntry="this.marginTop='10px';"></lido-image>`}
