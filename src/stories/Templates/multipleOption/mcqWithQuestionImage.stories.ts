		...
		<lido-cell visible="true" layout="col" width="100%" height="100%" bg-color="transparent">
			...
			<lido-cell visible="true" width="68%" height="landscape.68%, portrait.90%" bg-color="transparent" layout="landscape.row, portrait.col"  margin="landscape.0, portrait.-108px 0 0 0">
					...
					<lido-cell visible="true" layout="wrap" width="landscape.40%, portrait.80%" height="landscape.97%, portrait.auto" bg-color="transpernt" gap="40px" onEntry="" margin="landscape.0, portrait.-195px 0 0 0">
							...
							<lido-cell tab-index="2" visible="true" show-speak-icon="true" layout="col" width="100%" type="click" audio="${args.audio1}" value="${args.option1}" height="landscape.250px, portrait.250px" onEntry="this.borderRadius='25px'; this.padding='0';this.position='relative';" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" >
							...
							<lido-cell tab-index="3" visible="true" show-speak-icon="true" layout="col" width="100%" type="click" audio="${args.audio2}" value="${args.option2}" height="landscape.250px, portrait.250px" onEntry="this.borderRadius='25px'; this.padding='0'; this.position='relative';" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" >
