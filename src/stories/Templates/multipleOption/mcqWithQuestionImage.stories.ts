		...
		<lido-cell visible="true" layout="col" width="100%" height="100%" bg-color="transparent">
			...
			<lido-cell visible="true" width="68%" height="landscape.68%, portrait.90%" bg-color="transparent" layout="landscape.row, portrait.col"  margin="landscape.0, portrait.-108px 0 0 0">
					...
					<lido-cell visible="true" layout="wrap" width="landscape.40%, portrait.80%" height="landscape.97%, portrait.auto" bg-color="transparent" gap="40px" onEntry="" margin="landscape.0, portrait.-195px 0 0 0">
							...
							<lido-cell tab-index="2" visible="true" layout="col" width="100%" type="click" audio="${args.audio1}" value="${args.option1}" height="landscape.250px, portrait.270px" onEntry="this.borderRadius='25px'; this.padding='0';" onCorrect="this.applyBorderToCell='#65BC46';" onInCorrect="this.shakeCell='horizontal-shake';" onTouch="">
							...
							<lido-cell tab-index="3" visible="true" layout="col" width="100%" type="click" audio="${args.audio2}" value="${args.option2}" height="landscape.250px, portrait.270px" onEntry="this.borderRadius='25px'; this.padding='0';" onCorrect="this.applyBorderToCell='#65BC46';" onInCorrect="this.shakeCell='horizontal-shake';" onTouch="this.speak='true';">
							...
							<lido-cell tab-index="4" visible="true" layout="col" width="100%" type="click" audio="${args.audio3}" value="${args.option3}" height="landscape.250px, portrait.270px" onEntry="this.borderRadius='25px'; this.padding='0';" margin="landscape.0, portrait.20px 0 0 0" onCorrect="this.border='this.applyBorderToCell='#65BC46';" onInCorrect="this.shakeCell='horizontal-shake';" onTouch="">
							...
							<lido-cell tab-index="5" visible="true" layout="col" width="100%" type="click" audio="${args.audio4}" value="${args.option4}" height="landscape.250px, portrait.270px" onEntry="this.borderRadius='25px'; this.padding='0';" margin="landscape.0, portrait.20px 0 0 0" onCorrect="this.applyBorderToCell='#65BC46';" onInCorrect="this.shakeCell='horizontal-shake';" onTouch="">
