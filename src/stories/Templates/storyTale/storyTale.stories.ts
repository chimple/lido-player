...
function getContainerXml(args){
	return `<main>
		...
		<lido-cell id="cell1" margin="landscape.140px 0px 0px 0px,portrait.130px 0px 0px 0px" visible="true" layout="landscape.row,portrait.col" disableEdit="true" value="cell1" width="landscape.100%,portrait.86%" height="landscape.100%,portrait.80%" x="50px" y="50px" bgColor="white" type="" tabIndex="1" onEntry="this.justifyContent='space-evenly'; this.borderRadius='6px'" onTouch="" onCorrect="" onInCorrect="">
