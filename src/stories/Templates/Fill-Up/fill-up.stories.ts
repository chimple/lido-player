		...
		<lido-cell layout="col" visible="true" width="100%" height="100%" bg-color="transparent">
			...
			<lido-cell layout="landscape.row, portrait.col" visible="true" width="landscape.75%, portrait.76%" height="landscape.57%, portrait.73%" bg-color="white" onEntry="this.borderRadius='10px'; this.padding='8px';" margin="landscape.0 , portrait. -164px 0px -308px">
				...
				<lido-cell layout="flex" visible="true" height="landscape.100%,portrait.50%" width="landscape.50%, portrait.90%" onEntry="this.align-content='center'; this.gap='32px';this.display='ruby';" margin="landscape.73px 40px 0px 0px, portrait.21px 0px 0px 0px">
					<lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${args.text1}" bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px'; "></lido-text>
					<lido-text id="drop1"   disable-edit="true" tab-index="3" visible="true" width="164px" height="landscape.73px,portrait.77px" value="${args.answer1}"  type="drop" is-allow-only-one-drop="true" onEntry="this.border-radius='10px';this.box-shoadow=''; this.margin-right='18px';" ></lido-text>
					<lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${args.text2}" bg-color="transparent" onEntry="this.display='inline';this.boxShadow='0 0 0'; this.padding='0px 18px 0px 0px';"></lido-text>
					<lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${args.text3}" bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px';"></lido-text>
					<lido-text id="drop2"    disable-edit="true" tab-index="4" visible="true" width="164px" height="landscape.73px,portrait.77px" value="${args.answer2}" type="drop" is-allow-only-one-drop="true" onEntry="this.border-radius='10px'; this.margin-right='18px'; " ></lido-text>
					<lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${args.text4}" bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px'; "></lido-text>
					<lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${args.text5}" bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px'; "></lido-text>
					<lido-text id="drop3"   disable-edit="true" tab-index="5" visible="true" width="164px" height="landscape.73px,portrait.77px" value="${args.answer3}" type="drop" is-allow-only-one-drop="true" onEntry="this.border-radius='10px'; this.margin-right='18px';  "></lido-text>
					<lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${args.text6}" bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px';"></lido-text>
					<lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${args.text7} " bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px'; "></lido-text>
					<lido-text id="drop4"    disable-edit="true" tab-index="6" visible="true" width="164px" height="landscape.73px,portrait.77px" value="${args.answer4}" type="drop" is-allow-only-one-drop="true" onEntry="this.border-radius='10px'; this.margin-right='18px';" ></lido-text>
					<lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${args.text8}" bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px'; "></lido-text>
				</lido-cell>
			...
			<lido-cell layout="landscape.row, portrait.wrap" childElementsLength="4" onEntry="this.gap='28px';    this.gridTemplateColumns = 'repeat(2, 1fr)';  this.gridTemplateRows = 'repeat(2, 1fr)';" visible="true" margin="landscape.0px 434px 91px 0px, portrait.243px 338px -28px 0px">
				...
				<lido-text font-family="'Baloo Bhai 2'" id="option2" value="${args.option2}" tab-index="8" visible="true" bg-color="#fcf3b1" onEntry=" this.borderRadius='24px';  this.fontWeight='400';" width="landscape.174px, portrait.164px" height="landscape.87px, portrait.91px" string="${args.option2}" fontColor="black" font-size="40px" dropAttr="stretch" type="drag">
				</lido-text>
				<lido-text font-family="'Baloo Bhai 2'" id="option3" value="${args.option3}" tab-index="9" visible="true" bg-color="#fcf3b1" onEntry=" this.borderRadius='24px'; this.fontWeight='400';" width="landscape.174px, portrait.164px" height="landscape.87px, portrait.91px" string="${args.option3}" fontColor="black" font-size="40px" dropAttr="stretch"  type="drag">
				</lido-text>
