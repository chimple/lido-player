	...
	<lido-cell id="pos1" tabIndex="2" layout="landscape.row, portrait.col" height="100%" width="100%" visible="true" bgColor="transparent">
		...
		<lido-cell id="pos3" tabIndex="5" layout="landscape.col, portrait.row" disableEdit="true" value="pos" ariaHidden="true" x="0" y="0" z="0" bgColor="transparent" type="" visible="true" audio="" onTouch="" onCorrect="" width="100%" height="100%" onEntry="">
			<lido-cell id="pos4" tabIndex="6" layout="pos" disableEdit="true" value="pos" ariaHidden="true" x="0" y="0" z="0" bgColor="transparent" type="" visible="true" audio="" onTouch="" width="100%" height="100%" onEntry="this.animation='rightToPlace 2.5s linear'; this.sleep='2000'">
		    	...
		    	<lido-text id="text1" tabIndex="9" visible="true"  width="landscape.16%, portrait.25%" height="landscape.9%, portrait.6%"  z="3" x="landscape.43%, portrait.46%" y="landscape.23%, portrait.41%" type="drop" value="${args.option1}" isAllowOnlyOneDrop="true" onEntry="this.border='5px dashed black'" bgColor="#fbfbfbcf"></lido-text>
		    	<lido-text id="text2" tabIndex="10" visible="true"  width="landscape.16%, portrait.25%" height="landscape.9%, portrait.6%"  z="3" x="landscape.59%, portrait.71%" y="landscape.33%, portrait.48%" type="drop" value="${args.option2}" isAllowOnlyOneDrop="true" onEntry="this.border='5px dashed black'" bgColor="#fbfbfbcf"></lido-text>
				<lido-text id="text3" tabIndex="11" visible="true" width="landscape.16%, portrait.25%" height="landscape.9%, portrait.6%" z="3" x="landscape.57%, portrait.68%" y="landscape.56%, portrait.59%" type="drop" value="${args.option3}" isAllowOnlyOneDrop="true" onEntry="this.border='5px dashed black'" bgColor="#fbfbfbcf"></lido-text>
				<lido-text id="text4" tabIndex="12" visible="true"  width="landscape.16%, portrait.25%" height="landscape.9%, portrait.6%" z="3" x="landscape.28%, portrait.24%" y="landscape.54%, portrait.58%" type="drop" value="${args.option4}" isAllowOnlyOneDrop="true" onEntry="this.border='5px dashed black'" bgColor="#fbfbfbcf"></lido-text>
	   		</lido-cell>	
		</lido-cell> 
		<lido-cell id="pos5" tabIndex="13" layout="landscape.col, portrait.row" disableEdit="true" value="pos" ariaHidden="true" x="0%" y="0" z="3" bgColor="transparent" type="" visible="true" audio="" onTouch=""  width="landscape.27%, portrait.100%" height="landscape.100%, portrait.27%" onCorrect="" onEntry="this.visibility='hidden'; this.sleep='2500';this.visibility='visible'">
	        ...
	        <lido-text id="text5" tabIndex="15" height="landscape.16%, portrait.98%" width="landscape.76%, portrait.27%" type="drag" font="'Baloo Bhai 2'" visible="true"  fontColor="black" font-size="50px" value="${args.option1}" string="${args.option1}" onTouch="this.speak='true'"  bgColor="#DFF2F2" onEntry=" this.fontWeight='400'; this.boaderRadius='2px"></lido-text>
	        <lido-text id="text6" tabIndex="16" height="landscape.16%, portrait.98%" width="landscape.76%, portrait.27%" type="drag" font="'Baloo Bhai 2'" visible="true"  font-size="50px" value="${args.option2}" string="${args.option2}" onTouch="this.speak='true'"  bgColor="#DFF2F2" onEntry=" this.fontWeight='400'; this.boaderRadius='2px'"></lido-text>
	        <lido-text id="text7" tabIndex="17" height="landscape.16%, portrait.98%" width="landscape.76%, portrait.27%" type="drag" font="'Baloo Bhai 2'" visible="true"  font-size="50px" value="${args.option3}" string="${args.option3}" onTouch="this.speak='true'" bgColor="#DFF2F2" onEntry=" this.fontWeight='400'; this.boaderRadius='2px'"></lido-text>
			<lido-text id="text8" tabIndex="18" height="landscape.16%, portrait.98%" width="landscape.76%, portrait.27%" type="drag" font="'Baloo Bhai 2'" visible="true"  font-size="50px" value="${args.option4}" string="${args.option4}cheek" onTouch="this.speak='true'"  bgColor="#DFF2F2" onEntry=" this.fontWeight='400'; this.boaderRadius='2px'"></lido-text>
 		</lido-cell>
	</lido-cell>
</lido-cell>	
