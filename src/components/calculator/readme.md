...
| `penIcon`   | `pen-icon`  | Icon URL for the pen image shown on the calculator UI                                       | `string`            | `"https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/calculator/penIcon.png"` |
