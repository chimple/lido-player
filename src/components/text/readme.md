...
| `bgImage`                | `bg-image`                 | Background image of the text component.                                                                                                                                                                                | `string`            | `undefined` |
...
| `visible`                | `visible`                  | Controls the visibility of the text component. If `true`, the text is visible; otherwise, it is hidden.                                                                                                                | `boolean \| string` | `undefined` |
