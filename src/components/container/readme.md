...
| `showDropBorder`           | `show-drop-border`             |                                                                                                                                                   | `boolean` | `true`   |
| `showNextButton`           | `show-next-button`             | Indicates whether the next button should be displayed. Expected values: "true" or "false".                                                        | `boolean` | `false`  |
| `showPrevButton`           | `show-prev-button`             | Indicates whether the previous button should be displayed. Expected values: "true" or "false".                                                    | `boolean` | `false`  |
