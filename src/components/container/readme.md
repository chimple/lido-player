...
| `isContinueOnCorrect` | `is-continue-on-correct` | Specifies whether the activity should continue automatically upon a correct response. Expected values: "true" or "false". | `string`  | `undefined` |
...
| `showCheck`           | `show-check`             | Indicates whether the "Check" button should be visible or not. Expected values: "true" or "false".                        | `string`  | `undefined` |
