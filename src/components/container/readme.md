...
| `isContinue`  | `is-continue`   |                                                                                                                  | `string`  | `undefined` |
...
| `onInCorrect` | `on-in-correct` | Event handler triggered when a specific match condition is met within the container.                             | `string`  | `undefined` |
| `onTouch`     | `on-touch`      | Event handler triggered when the container is touched or clicked.                                                | `string`  | `undefined` |
| `showCheck`   | `show-check`    |                                                                                                                  | `string`  | `undefined` |
