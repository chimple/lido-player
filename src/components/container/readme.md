...
| `highlightWordByWord`      | `highlight-word-by-word`       | When set to true, highlights each word individually during speech playback.                                                                       | `boolean` | `false`     |
...
| `showDropBorder`           | `show-drop-border`             | Controls whether the drop zone displays a border; true shows the border, false hides it.                                                          | `boolean` | `true`      |
| `showNextButton`           | `show-next-button`             | Indicates whether the next button should be displayed. Expected values: "true" or "false".                                                        | `string`  | `'false'`   |
