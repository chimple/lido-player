...
| `moving`          | `moving`            | Specifies whether the component is currently in a moving state. This can be used to control animations or transitions. Defaults to `false`.                                             | `boolean` | `false`                                                                                                |
