...
| `id`         | `id`          | Unique identifier for this `app-trace` component instance.                                                                                                                               | `string` | `undefined` |
| `mode`       | `mode`        | Mode for the tracing interaction, defining how users interact with the SVG paths. Options may include `"noFlow"`, `"showFlow"`, `"freeTrace"`, `"blindTracing"`, and `"blindFreeTrace"`. | `string` | `undefined` |
