...
| `onInCorrect` | `on-in-correct` | Event handler for a Correct touch event, where a custom function can be triggered when the column is touched.    | `string`  | `undefined` |
