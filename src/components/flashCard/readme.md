...
| `bgColor`     | `bg-color`      | Background color of the column (CSS color value, e.g., '#FFFFFF', 'blue').                                                                                               | `string`  | `undefined` |
...
| `onEntry`     | `on-entry`      | Event handler triggered when the column is entered, useful for triggering animations or logic.                                                                           | `string`  | `undefined` |
...
| `x`           | `x`             | X-axis (horizontal) position of the column within its container (CSS value, e.g., '10px', '5%').                                                                         | `string`  | `undefined` |
| `y`           | `y`             | Y-axis (vertical) position of the column within its container (CSS value, e.g., '10px', '5%').                                                                           | `string`  | `undefined` |
| `z`           | `z`             | Z-index for stacking order of the column relative to other elements.                                                                                                     | `string`  | `undefined` |
