...
| `filter`      | `filter`        | CSS filter to apply visual effects (e.g., blur, brightness) to the image. Example: 'blur(5px)', 'brightness(0.8)', 'grayscale(100%)' | `string`            | `'white'`   |
...
| `margin`      | `margin`        | margin to adjust the position of element                                                                                             | `string`            | `''`        |
