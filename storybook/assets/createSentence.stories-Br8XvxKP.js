        ...
        <lido-cell id="row1" layout="col" height="100%" width="100%" visible="true" bg-Color="transparent">
            ...
            <lido-cell id="col" layout="col" disable-edit="true" value="pos" aria-hidden="true" x="0" y="0" z="0" bg-color="transparent" type="" visible="true" audio="" onTouch="" onCorrect="" width="100%" height="100%" onEntry="">
                ...
                <lido-cell layout="landscape.flex,portrait.wrap" visible="true" width="landscape.86%, portrait.88%" y="landscape.65%, portrait.62%" x="landscape.4%,portrait.0px" z="2" onEntry="this.gridTemplateColumns = 'repeat(4, 1fr)';  this.gridTemplateRows = 'repeat(2, 1fr)';this.position='relative';this.gap='40px';">
                    ...
                    <lido-text id="option2" show-speak-icon="true" audio="${t.option2Audio}" value="${t.option2}" tab-index="10"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; " width="auto" height="84px" string="${t.option2}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">

                    </lido-text>
                    <lido-text id="option3" show-speak-icon="true" audio="${t.option3Audio}" value="${t.option3}" tab-index="11"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; " width="auto" height="84px" string="${t.option3}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                    <lido-text id="option4" show-speak-icon="true" audio="${t.option4Audio}" value="${t.option4}" tab-index="12"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; " width="auto" height="84px" string="${t.option4}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                    <lido-text id="option5" show-speak-icon="true" audio="${t.option5Audio}" value="${t.option5}" tab-index="13"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; " width="auto" height="84px" string="${t.option5}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                    <lido-text id="option6" show-speak-icon="true" audio="${t.option6Audio}" value="${t.option6}" tab-index="14"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800';" width="auto" height="84px" string="${t.option6}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
