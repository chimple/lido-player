import"./lit-element-DRlmAcsz.js";import{b as c}from"./lit-html-s0HVm7S4.js";const g={title:"Templates/palEgraBuildWord",argTypes:{options:{control:"object"},PracticeMode:{control:"boolean"}}},i={args:{question_text:"Listen to the word and build it with the letters below",question_word:["dance"],PracticeMode:!1},render:t=>{const o=h(t);return c`<lido-home .xmlData="${o}"></lido-home>`}};function h(t){const o=t.question_word[0],r=[...o],n=r.map((a,e)=>`
    <lido-text visible="true" id="drop${e+1}" tab-index="${12+e}" value="${a}" string="?" disable-speak="true" font-family="'Baloo Bhai 2'" width="173px" height="189px" is-allow-only-one-drop="true" font-color="#030028" font-size="landscape.140px, portrait.100px"  bg-color="#FFFFFF"  type="drop" onEntry="this.fontWeight='700'; this.border-radius='16px';">
    </lido-text>
  `).join(""),d=[...r].sort(()=>Math.random()-.5).map((a,e)=>`
    <lido-text visible="true" id="drag${e+1}" tab-index="${16+e}" value="${a}" string="${a}" disable-speak="true" font-family="'Baloo Bhai 2'" width="173px" height="189px" font-color="#FFFFFF" font-size="landscape.140px, portrait.100px"  bg-color="#A05730"  type="drag" onEntry="this.fontWeight='700'; this.border-radius='16px'; this.justifyContent='center'; this.alignItems='center';">
    </lido-text>
  `).join("");return`
<main>
...
}`,...(p=(s=i.parameters)==null?void 0:s.docs)==null?void 0:p.source}}};const m=["palEgraBuildWord"];export{m as __namedExportsOrder,g as default,i as palEgraBuildWord};
