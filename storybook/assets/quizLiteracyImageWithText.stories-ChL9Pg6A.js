  ...
  <lido-container id="lido-container" value="maincontainer" visible="true" objective="${t.answer}"  bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/Underwater.png"  onEntry="" is-Continue-On-Correct="true" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" onCorrect="lido-avatar.avatarAnimate='Success'; this.sleep='2000';">
    ...
    <lido-cell layout="landscape.row,portrait.col" visible="true" bg-Color="transparent" width="landscape.114%,portrait.90%" height="68%" margin="landscape.0px,portrait.-322px 0px 0px 0px">
        ...
        <lido-cell layout="col" visible="true"  width="landscape.100%,portrait.108%" height="216px" bg-Color="transparent" margin="landscape.0px 160px 0px -299px,portrait.0px 0px 0px 0px" onEntry="this.align-items='center'; this.justify-content='center'; this.gap='40px';">
            <lido-text visible="true" audio="" onCorrect="this.border='5px solid green';this.cellBorderAnimate='#65BC46';" onInCorrect="this.border='5px solid red';this.vibrate='horizontal-shake';" show-speak-icon="true" id="option1" font-family="'Baloo Bhai 2'" tab-index="2" font-size="62px" border-radius="12px" font-color="black" height="120px" width="auto" string="${t.option1}" value="${t.option1}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
            <lido-text visible="true" audio="" show-speak-icon="true" id="option2" onCorrect="this.border='5px solid green';this.cellBorderAnimate='#65BC46';" onInCorrect="this.border='5px solid red';this.vibrate='horizontal-shake';" font-family="'Baloo Bhai 2'" tab-index="3" font-size="62px" border-radius="12px" font-color="black" height="120px" width="auto" string="${t.option2}" value="${t.option2}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
            <lido-text visible="true" audio="" show-speak-icon="true" id="option3" font-family="'Baloo Bhai 2'" tab-index="4" font-size="62px" onCorrect="this.border='5px solid green';this.cellBorderAnimate='#65BC46';" onInCorrect="this.border='5px solid red';this.vibrate='horizontal-shake';" border-radius="12px" font-color="black" height="120px" width="auto" string="${t.option3}" value="${t.option3}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
            <lido-text visible="true" audio="" show-speak-icon="true" id="option4" font-family="'Baloo Bhai 2'" tab-index="5" font-size="62px" border-radius="12px" font-color="black" height="120px" onCorrect="this.border='5px solid green';this.cellBorderAnimate='#65BC46';" onInCorrect="this.border='5px solid red';this.vibrate='horizontal-shake';" width="auto" string="${t.option4}" value="${t.option4}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
        </lido-cell>
...
}`,...(o=(a=e.parameters)==null?void 0:a.docs)==null?void 0:o.source}}};const d=["quizLiteracyImageWithText"];export{d as __namedExportsOrder,c as default,e as quizLiteracyImageWithText};
