...
`),l=a.map(t=>`
  ...
  `).join(`
`),p=`heading0.speak='true'; this.sleep='800'; ${e.heading.split("").map((t,o)=>`heading${o+1}.speak='true'; this.sleep='500';`).join(" ")}`;return`<main>
    <lido-container id="lido-container" tab-index="1" 
      bg-image="${e.backgroundImage}" 
  ...
  </main>`}var s,n,r;i.parameters={...i.parameters,docs:{...(s=i.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    objective: "mom",
    heading: "MOM",
    choice2Text: "mom",
...
}`,...(r=(n=i.parameters)==null?void 0:n.docs)==null?void 0:r.source}}};const x=["OpenWindow"];export{i as OpenWindow,x as __namedExportsOrder,u as default};
