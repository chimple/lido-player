import"./lit-element-BxxbMms4.js";import{x as c}from"./lit-html-DLYuhZ0i.js";const p={title:"Templates/CheckerBlock",argTypes:{shapeNumber:{control:"number"}}},a={args:{shapeNumber:1},render:t=>{const e=m();return c`<lido-home .xmlData="${e}"></lido-home>`}};function m(t){const e=d();return console.log("shape : ",e),`<main>
...
}`,...(r=(i=a.parameters)==null?void 0:i.docs)==null?void 0:r.source}}};const u=["CheckerBlock"];export{a as CheckerBlock,u as __namedExportsOrder,p as default};
