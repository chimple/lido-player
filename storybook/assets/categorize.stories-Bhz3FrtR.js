import"./lit-element-DRlmAcsz.js";import{b as c}from"./lit-html-s0HVm7S4.js";const p={title:"Templates/Categorize",argTypes:{options:{control:"object"},category1:{control:"text"},category2:{control:"text"},category3:{control:"text"},correct1:{control:"text"},correct2:{control:"text"},correct3:{control:"text"}}},e={args:{options:["Apple","Lion","Tiger","3","Strawberry","7","Mango","10"],category1:"Fruits",category2:"Numbers",category3:"Animals",correct1:"Apple,Strawberry,Mango",correct2:"3,7,10",correct3:"Lion,Tiger"},render:t=>{const o=s(t);return c`<lido-home .xmlData="${o}"></lido-home>`}};function s(t){return`
  <main>
    <lido-container id="lido-container" value="mainContainer1" objective="${`(${t.correct1.split(",").join("|")}),(${t.correct2.split(",").join("|")}),(${t.correct3.split(",").join("|")})`}" aria-label="" height="100vh" width="100vw" x="0" y="0" z="0" bg-color="#FFB742" visible="true" audio="background1.mp3" onTouch="" onCorrect="lido-avatar.avatarAnimate='Success'; this.sleep='2000';" onEntry="" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" show-check="true" is-continue-on-correct="true" is-allow-only-correct="false">
        <!-- Chimple Avatar -->
      ...
      <lido-row visible="true" bg-color="transparent" width="1500px" height="850px">
        ...
        ${t.options.map((i,n)=>`
          <lido-text visible="true" tab-index="${n+1}" bg-color="white" value="${i}" string="${i}" width="200px" height="80px" font-family="'Baloo 2', serif" font-size="30px" onEntry="this.fontWeight='800'; this.marginBottom='10px';" type="option"></lido-text>`).join("")}
        ...
        <lido-row visible="true" bg-color="transparent" width="1150px" height="840px">
          <lido-col id="cate1" visible="true" width="200px" height="700px" onEntry="this.border='2px solid';" bg-color="#0000005e" onTouch="this.addClass='highlight-element'; cate2.removeClass='highlight-element'; cate3.removeClass='highlight-element';">
            <lido-text tab-index="9" visible="true" width="200px" bg-color="black" font-color="white" string="${t.category1}" font-size="30px" font-family="'Baloo 2', serif" onEntry="this.fontWeight='800';"></lido-text>
            <lido-col visible="true" id="category1" tab-index="1" width="200px" height="100%" onEntry="this.display='block'; this.overflow='auto'; this.scrollbarWidth='none';" value="${t.correct1}" bg-color="transparent" type="category">
            </lido-col>
          </lido-col>
          <lido-col id="cate2" visible="true" width="200px" height="700px" onEntry="this.border='2px solid';" bg-color="#0000005e" onTouch="this.addClass='highlight-element'; cate1.removeClass='highlight-element'; cate3.removeClass='highlight-element';">
            <lido-text tab-index="10" visible="true" width="200px" bg-color="black" font-color="white" string="${t.category2}" font-size="30px" font-family="'Baloo 2', serif" onEntry="this.fontWeight='800';"></lido-text>
            <lido-col visible="true" id="category2" tab-index="2" width="200px" height="100%" onEntry="this.display='block'; this.overflow='auto'; this.scrollbarWidth='none';" value="${t.correct2}" bg-color="transparent" type="category"></lido-col>
          </lido-col>
          <lido-col id="cate3" visible="true" width="200px" height="700px" onEntry="this.border='2px solid';" bg-color="#0000005e" onTouch="this.addClass='highlight-element'; cate2.removeClass='highlight-element'; cate1.removeClass='highlight-element';">
            <lido-text tab-index="11" visible="true" width="200px" bg-color="black" font-color="white" string="${t.category3}" font-size="30px" font-family="'Baloo 2', serif" onEntry="this.fontWeight='800';"></lido-text>
            <lido-col visible="true" id="category3" tab-index="3" width="200px" height="100%" onEntry="this.display='block'; this.overflow='auto'; this.scrollbarWidth='none';" value="${t.correct3}" bg-color="transparent" type="category"></lido-col>
          </lido-col>
        </lido-row>
      </lido-row>
    </lido-container>
  </main>`}var r,l,a;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  args: {
...
}`,...(a=(l=e.parameters)==null?void 0:l.docs)==null?void 0:a.source}}};const g=["QuestionAndOptions"];export{e as QuestionAndOptions,g as __namedExportsOrder,p as default};
