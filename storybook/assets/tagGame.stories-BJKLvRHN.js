        ...
        <lido-cell id="pos1" tab-index="2" layout="landscape.row, portrait.col" height="100%" width="100%" visible="true" bg-color="transparent">
            ...
            <lido-cell id="pos3" tab-index="5" layout="landscape.col, portrait.row" disable-edit="true" value="pos" aria-hidden="true" x="0" y="0" z="0" bg-color="transparent" type="" visible="true" audio="" onTouch="" onCorrect="" width="100%" height="100%" onEntry="">
                <lido-cell id="pos4" tab-index="6" layout="pos" disable-edit="true" value="pos" aria-hidden="true" x="0" y="0" z="0" bg-color="transparent" type="" visible="true" audio="" onTouch="" width="100%" height="100%" onEntry="this.animation='rightToPlace 2.5s linear'; this.sleep='2000'">
                    <lido-image tab-index="7" width="landscape.87%, portrait.138%" height="landscape.137%, portrait.51%" y="landscape.-16%, portrait.32%" x="landscape.0%, portrait.-23%" custom-style=".redBg{background-color: red !important;} .greenBg{background-color: green !important; color: white !important;}" id="image1" disable-edit="true" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/tag/truck.png" onEntry="">
                    </lido-image>
                    ...
                    <lido-text id="text1" tab-index="9" visible="true" width="landscape.16%, portrait.25%" height="landscape.9%, portrait.6%" z="3" x="landscape.43%, portrait.46%" y="landscape.23%, portrait.41%" type="drop" value="${t.option1}" isAllowOnlyOneDrop="true" onEntry="this.border='5px dashed black'" bg-color="#fbfbfbcf"></lido-text>
                    <lido-text id="text2" tab-index="10" visible="true" width="landscape.16%, portrait.25%" height="landscape.9%, portrait.6%" z="3" x="landscape.59%, portrait.71%" y="landscape.33%, portrait.48%" type="drop" value="${t.option2}" isAllowOnlyOneDrop="true" onEntry="this.border='5px dashed black'" bg-color="#fbfbfbcf"></lido-text>
                    <lido-text id="text3" tab-index="11" visible="true" width="landscape.16%, portrait.25%" height="landscape.9%, portrait.6%" z="3" x="landscape.57%, portrait.68%" y="landscape.56%, portrait.59%" type="drop" value="${t.option3}" isAllowOnlyOneDrop="true" onEntry="this.border='5px dashed black'" bg-color="#fbfbfbcf"></lido-text>
                    <lido-text id="text4" tab-index="12" visible="true" width="landscape.16%, portrait.25%" height="landscape.9%, portrait.6%" z="3" x="landscape.28%, portrait.24%" y="landscape.54%, portrait.58%" type="drop" value="${t.option4}" isAllowOnlyOneDrop="true" onEntry="this.border='5px dashed black'" bg-color="#fbfbfbcf"></lido-text>
                </lido-cell>
            </lido-cell>
            <lido-cell id="pos5" tab-index="13" layout="landscape.col, portrait.row" disable-edit="true" value="pos" aria-hidden="true" x="0%" y="0" z="3" bg-color="transparent" type="" visible="true" audio="" onTouch="" width="landscape.27%, portrait.100%" height="landscape.100%, portrait.27%" onCorrect="" onEntry="this.visibility='hidden'; this.sleep='2500';this.visibility='visible'">
                <lido-cell id="pos6" tab-index="14" layout="landscape.col,portrait.row" disable-edit="true" value="pos" aria-hidden="true" x="landscape.85%, portrait.0%" y="landscape.23%, portrait.87%" z="2" bg-color="transparent" type="" visible="true" audio="" onTouch="" width="landscape.130%, portrait.102%" height="landscape.59%, portrait.42%" onCorrect="" onEntry="this.align-content='center'; this.gap='2%'">
                    <lido-text id="text5" tab-index="15" height="landscape.16%, portrait.98%" width="landscape.76%, portrait.27%" type="drag" font="'Baloo Bhai 2'" visible="true" fontColor="black" font-size="50px" value="${t.option1}" string="${t.option1}" onTouch="this.speak='true'" bg-color="#DFF2F2" onEntry=" this.fontWeight='400'; this.boaderRadius='2px"></lido-text>
                    <lido-text id="text6" tab-index="16" height="landscape.16%, portrait.98%" width="landscape.76%, portrait.27%" type="drag" font="'Baloo Bhai 2'" visible="true" font-size="50px" value="${t.option2}" string="${t.option2}" onTouch="this.speak='true'" bg-color="#DFF2F2" onEntry=" this.fontWeight='400'; this.boaderRadius='2px'"></lido-text>
                    <lido-text id="text7" tab-index="17" height="landscape.16%, portrait.98%" width="landscape.76%, portrait.27%" type="drag" font="'Baloo Bhai 2'" visible="true" font-size="50px" value="${t.option3}" string="${t.option3}" onTouch="this.speak='true'" bg-color="#DFF2F2" onEntry=" this.fontWeight='400'; this.boaderRadius='2px'"></lido-text>
                    <lido-text id="text8" tab-index="18" height="landscape.16%, portrait.98%" width="landscape.76%, portrait.27%" type="drag" font="'Baloo Bhai 2'" visible="true" font-size="50px" value="${t.option4}" string="${t.option4}" onTouch="this.speak='true'" bg-color="#DFF2F2" onEntry=" this.fontWeight='400'; this.boaderRadius='2px'"></lido-text>
                </lido-cell>
            </lido-cell>
        </lido-cell>
    </lido-container> 
...
}`,...(a=(i=e.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const c=["QuestionAndOptions"];export{e as QuestionAndOptions,c as __namedExportsOrder,s as default};
