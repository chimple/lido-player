import"./lit-element-BxxbMms4.js";import{x as d}from"./lit-html-DLYuhZ0i.js";const u={title:"Templates/letterboard"},t={render:l=>{const e=b();return d`<lido-home xml-data="${e}" xmlData="${e}"></lido-home>`}};function o(){return"ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("").map((e,r)=>`
    <lido-image id="drag${e}" value="${e}" type="drag" tabIndex="${30+r}" disableEdit="true" visible="true"
...
</main>`}var a,s,i;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render: args => {
    const xml = getContainerXml();
    return html\`<lido-home xml-data="\${xml}" xmlData="\${xml}"></lido-home>\`;
  }
}`,...(i=(s=t.parameters)==null?void 0:s.docs)==null?void 0:i.source}}};const g=["letterBoard"];export{g as __namedExportsOrder,u as default,t as letterBoard};
