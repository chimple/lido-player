import"./lit-element-DByy2wOb.js";import{b as h}from"./lit-html-BGZAEiha.js";const m={title:"Templates/Phonic-tractor",argTypes:{text1:{control:"text"},options:{control:"object"},answers:{control:"object"},isAllowOnlyCorrect:{control:"boolean",name:"Allow Only Correct"}}},a={args:{text1:"fox",options:["f","o","x"],answers:["f","o","x"],isAllowOnlyCorrect:!0},render:o=>{const t=g(o);return h`<lido-home .xmlData="${t}"></lido-home>`}};function g(o){let t=1;const{text1:l,options:c=[],answers:r=[],isAllowOnlyCorrect:i}=o,d=r.map(e=>`
        <!-- drop and trolley -->
