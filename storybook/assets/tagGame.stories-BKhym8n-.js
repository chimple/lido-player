import"./lit-element-DRlmAcsz.js";import{b as l}from"./lit-html-s0HVm7S4.js";const c={title:"Templates/tagGame",argTypes:{question:{control:"text"},option1:{control:"text"},option2:{control:"text"},option3:{control:"text"},option4:{control:"text"},correct1:{control:"text"},correct2:{control:"text"},correct3:{control:"text"},correct4:{control:"text"}}},e={args:{option1:"Face",option2:"Forehead",option3:"chin",option4:"cheek",correct1:"Face",correct2:"Forehead",correct3:"chin",correct4:"cheek"},render:t=>{const r=n(t);return l`<lido-home .xmlData="${r}"></lido-home>`}};function n(t){return`<main>
