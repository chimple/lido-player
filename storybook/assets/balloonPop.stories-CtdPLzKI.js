import"./lit-element-DByy2wOb.js";import{b as n}from"./lit-html-BGZAEiha.js";const d={title:"Templates/BalloonPop",argTypes:{Increment:{control:"text"},Decrement:{control:"text"},cells:{control:{type:"object"},description:"Array of balloon cells with value and filter"},objective:{control:"text"}}},t={args:{Increment:"+10",Decrement:"-10",objective:"A",cells:[{value:"A",filter:"violet"},{value:"B",filter:"red"},{value:"A",filter:"blue"},{value:"B",filter:"blue"},{value:"B",filter:"yellow"},{value:"A",filter:"grey"},{value:"A",filter:"white"}]},render:e=>{const l=s(e);return n`<lido-home .xmlData="${l}"></lido-home>`}};function s(e){const l=e.cells.map(i=>`
