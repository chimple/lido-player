import"./lit-element-BxxbMms4.js";import{x as $}from"./lit-html-DLYuhZ0i.js";const R={title:"Templates/questionBoard",argTypes:{questionBoardImage:{control:"file",name:"Question Board Image URL",multiple:!0},questionBoardText:{control:"text",name:"Question Board Text"},backgroundImagePlusSign1:{control:"file",name:"Background Image 1 URL for (+,- sign)",multiple:!0},backgroundImagePlusSign2:{control:"file",name:"Background Image 2 URL for (+,- sign)",multiple:!0},backgroundImageMultiplicationSign:{control:"file",name:"Background Image URL for (x sign)",multiple:!0},expressionText:{control:"text",name:"Expression Text"},options:{control:"object",name:"Options"},optionText:{control:"text",name:"Option Text"},objective:{control:"text",name:"Objective",description:"Objective to achieve the task. (E.g. 5)"},isAllowOnlyCorrect:{control:"boolean",name:"isAllowOnlyCorrect"}},args:{questionBoardImage:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/question-board/wordwindow_frame_question.png"],questionBoardText:"The library has 5 more tables than the school office. The school office has 2 tables. How many tables does the library have?",backgroundImagePlusSign1:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/Categorize/insect3.png"],backgroundImagePlusSign2:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/Categorize/insect3.png"],backgroundImageMultiplicationSign:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/Categorize/insect3.png"],expressionText:"5 + 2 = 7",options:[5,7,12,18],optionText:"tables",objective:"7",isAllowOnlyCorrect:!0}},m={args:{questionBoardText:"The library has 5 more tables than the school office. The school office has 2 tables. How many tables does the library have?",optionText:"tables",options:[5,7,12,18]},render:t=>{const r=C(t);return $`<lido-home xml-data="${r}" xmlData="${r}"></lido-home>`}},z=t=>{const r=t.trim();console.log("Expression Text:",r);const[e,o]=r.split("=").map(a=>a.trim());console.log("Left:",e),console.log("Right:",o);const u=o.trim().includes("+")||o.trim().includes("-")||o.trim().includes("x")||o.trim().includes("X")||o.trim().includes("*"),x=e.trim().includes("+")||e.trim().includes("-")||e.trim().includes("x")||e.trim().includes("X")||e.trim().includes("*");console.log("isLeftResult:",u),console.log("isRightResult:",x);const i=u?e.trim().replace(/[<>]/g,""):x?o.trim().replace(/[<>]/g,""):"";if(console.log("Result:",i),u){const a=o.match(/(\+|-|x|X|\*)/),s=a?a[1]:"";console.log("Operator:",s);const[l,c]=o.split(/(\+|-|x|X|\*)/).filter(n=>!["+","-","x","X","*"].includes(n)).map(n=>n.trim()),p=l?l.replace(/[<>]/g,"").trim():"",d=c?c.replace(/[<>]/g,"").trim():"";return console.log("Num1:",p),console.log("Num2:",d),{num1:p,num2:d,operator:s,result:i}}if(x){const a=e.match(/(\+|-|x|X|\*)/),s=a?a[1]:"";console.log("Operator:",s);const[l,c]=e.split(/(\+|-|x|X|\*)/).filter(n=>!["+","-","x","X","*"].includes(n)).map(n=>n.trim()),p=l?l.replace(/[<>]/g,"").trim():"",d=c?c.replace(/[<>]/g,"").trim():"";return console.log("Num1:",p),console.log("Num2:",d),{num1:p,num2:d,operator:s,result:i}}};function C(t){const r=t.questionBoardImage[0],e=t.questionBoardText,o=t.backgroundImagePlusSign1[0],u=t.backgroundImagePlusSign2[0],x=t.backgroundImageMultiplicationSign[0],i=t.expressionText,a=t.optionText,s=t.objective,l=t.isAllowOnlyCorrect??!0,c=t.options;let p=4;const d=c.map(f=>`
        ...
        `).join(""),n=i.includes("+")||i.includes("-"),T=i.includes("X")||i.includes("x")||i.includes("*"),v=n?`
    ...
    `:"";console.log("Expression Animation: ",v);const{num1:g,num2:b,operator:q,result:B}=z(i),h=i.replace(/</g,"&lt;").replace(/>/g,"&gt;");let E=parseInt(g)<=10?"1":"2",I=parseInt(b)<=10?"1":"2";return console.log("Expression Text: ",h),`
        <main>
                <lido-container id="question-board-container" disable-speak="true" objective="${s}" tab-index="1"  value="questionBoard" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/background-images/Question%20board.png"  height="100%" width="100%" bg-color="transparent"  visible="true" onCorrect="lido-avatar.avatarAnimate='Success'; this.sleep='2000'; question-board-image.transition='transform 1s ease'; question-board-image.transform='rotateY(180deg)'; question-board-text.transition='opacity 0.5s ease'; question-board-text.opacity='0'; option-row.opacity='0'; invisible-text.transition='opacity 0.5s ease'; invisible-text.opacity='1'; invisible-text.visibility='visible'; ${v} this.sleep='4000';" onEntry="this.justifyContent='space-around';" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" show-check="false" is-continue-on-correct="true" is-allow-only-correct="${l}" >
                    ...
                    <lido-cell layout="pos" id="pos3" value="pos3" x="landscape.445px, portrait.45px" y="landscape.115px, portrait.145px" visible="true" height="landscape.60%,portrait.10%" width="landscape.55%,portrait.92%" border-radius="7px" bg-color="transparent" onEntry="this.z-index='1';">
                        <lido-text visible="true" id="question-board-text" tab-index="3" audio="" font-family="'Baloo 2', serif" font-size="landscape.60px, portrait.52px" font-color="black" string="${e}" bg-Color="transparent" onEntry="this.font-weight='700'; this.textAlign='left'; this.lineHeight='1.25';" >
                        </lido-text>
                    </lido-cell>
                    ...
                    <lido-cell layout="pos" id="invisible-text" disableEdit="true" value="pos3" height="landscape.10%, portrait.710px" width="landscape.75%, portrait.875px" x="landscape.325px, portrait.10px" y="landscape.740px, portrait.475px" ariaHidden="true" z="1" bg-color="transparent" visible="true"  onEntry="this.flex-shrink='0'; this.opacity='0'; this.z-index='0';">
                        <lido-text id="txt2" audio="" tab-index="8" height="inherit" width="inherit" visible="true" value="${h}" string="${h}" font-family="'Baloo Bhai 2'" font-color="white" font-size="104px"  bg-color="transparent" onCorrect="" onInCorrect="this.vibrate='horizontal-shake';" onEntry="this.font-weight='800'; this.borderRadius='10px'; this.flex-shrink='0';">
                        </lido-text>
                    </lido-cell>
                    ...
                    <lido-cell layout="pos" id="background-animation-plus-minus-1" value="pos5" height="600px" width="600px" x="landscape.475px, portrait.85px" y="landscape.-110px,portrait.-80px" ariaHidden="true" z="1" bg-color="transparent" visible="true" onEntry="this.opacity='0';">
                        <lido-math-matrix visible="true" rows="10" cols="${E}" top-index="false" left-index="false" bottom-index="false" clickable="false" active-only-visible="true" active-bg-color="yellow" inactive-bg-color="black" defualt-fill="${g}" matrix-image="${o}"></lido-math-matrix>
                    </lido-cell>
                    <lido-cell layout="pos" id="background-animation-plus-minus-2" value="pos5" height="600px" width="600px" x="landscape.475px, portrait.85px" y="landscape.130px, portrait.75px" ariaHidden="true" z="1" bg-color="transparent" visible="true" onEntry="this.opacity='0';">
                        <lido-math-matrix visible="true" rows="10" cols="${I}" top-index="false" left-index="false" bottom-index="false" clickable="false" active-only-visible="true" active-bg-color="yellow" inactive-bg-color="black" defualt-fill="${b}" matrix-image="${u}"></lido-math-matrix>
                    </lido-cell>
                    ...
                    <lido-cell layout="pos" id="background-animation-multiplication" value="pos5" height="600px" width="600px" x="landscape.530px, portrait.125px" y="landscape.50px, portrait.15px" ariaHidden="true" z="1" bg-color="transparent" visible="true" onEntry="this.opacity='0';">
                        <lido-math-matrix visible="true" rows="${g}" cols="${b}" top-index="false" left-index="false" bottom-index="false" clickable="false" active-only-visible="true" active-bg-color="yellow" inactive-bg-color="black" defualt-fill="${B}" matrix-image="${x}"></lido-math-matrix>
                    </lido-cell>

                </lido-container>
        </main>
    `}var y,k,w;m.parameters={...m.parameters,docs:{...(y=m.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
...
}`,...(w=(k=m.parameters)==null?void 0:k.docs)==null?void 0:w.source}}};const A=["QuestionBoard"];export{m as QuestionBoard,A as __namedExportsOrder,R as default};
