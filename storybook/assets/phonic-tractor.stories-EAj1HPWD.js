import"./lit-element-BxxbMms4.js";import{x}from"./lit-html-DLYuhZ0i.js";const m={title:"Templates/Phonic-tractor",argTypes:{text1:{control:"text"},options:{control:"object"},answers:{control:"object"}}},a={args:{text1:"fox",options:["f","o","x"],answers:["f","o","x"]},render:o=>{const i=h(o);return x`<lido-home .xmlData="${i}"></lido-home>`}};function h(o){const{text1:i,options:l=[],answers:r=[]}=o,c=r.map((e,t)=>`
        <!-- drop and trolley -->
        <lido-cell height="237px" width="200px" visible="true" bg-color="transparent" layout="col" >
            <lido-text id="t${t+1}" type="drop" tab-index="${t+2}" bg-color="transparent" height="132px" width="132px" value="${e}" is-allow-only-one-drop="true" margin="-25px 0px 16px 0px" onEntry=" this.borderRadius='6px';">
            </lido-text>
            <lido-image id="img${t+4}" visible="true"  disable-edit="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/phonic-tractor/phonictractor_tractor_holder.png" height="97px" width="220px" >
            </lido-image>
        </lido-cell>
      `).join(""),d=l.map((e,t)=>`
        <lido-text id="option${t+1}" tab-index="${t+5}" width="132px"  height="132px" value="${e}"  visible="true" string="${e}" font-family="'Baloo Bhai 2'" font-color="white" type="drag" font-size="landscape.96px, portrait.96px" bg-color="transparent" onEntry="  this.fontWeight='600';this.borderRadius='10px';"  margin="landscape.150px 0px 112px 0px, portrait.0px 0px 0px 0px"  border-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/phonic-tractor/box.png" onTouch="" show-speak-icon="true" >
        </lido-text>
      `).join("");return`
    <main>
    <lido-container id="lido-container" appendToDropOnCompletion="true" value="mainContainer1" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/phonic-tractor/bg-image.png"  bg-color="transparent" objective="${r.join(",")}" height="100%" width="100%" visible="true" show-check="false" is-continue-on-correct="true" after-drop="false" onCorrect="lido-avatar.avatarAnimate='Success';this.sleep='1000';  b1.animation='placeToLeft 2s linear'; this.sleep='2000';"  onEntry="this.justifyContent='space-around';" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';"   > 
        ...
        <lido-cell layout="col" visible="true" width="100%" height="100%"  bg-color="transparent" margin="landscape.-38px 0px -122px 0px, portrait.0px 0px 0px 0px">
            ...
            <lido-image visible="true" id="img1" height="140px" width="361px"  disable-edit="true" is-slice="true" bg-color="transparent" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/phonic-tractor/board.png" margin="landscape.42px 0px -126px 0px, portrait.-58px 0px 60px 0px" show-speak-icon="true" >
                <lido-text id="heading"  tab-index="1" height="100px"  visible="true" string="${i}" font-family="'Baloo Bhai 2'" font-color="white" font-size="landscape.96px, portrait.96px" bg-color="transparent" onEntry="  this.fontWeight='600';"   margin="landscape.0px 0px 0px 0px, portrait.0px 0px 0px 0px" >
                </lido-text>
            </lido-image>
            <!-- tractor -->
...
}`,...(n=(s=a.parameters)==null?void 0:s.docs)==null?void 0:n.source}}};const u=["PhonicTractor"];export{a as PhonicTractor,u as __namedExportsOrder,m as default};
