import"./lit-element-BxxbMms4.js";import{x as r}from"./lit-html-DLYuhZ0i.js";const p={title:"Templates/wordBuildingwithoutimg",argTypes:{option1:{control:"text"},option2:{control:"text"},option3:{control:"text"},option4:{control:"text"},option5:{control:"text"},isAllowOnlyCorrect:{control:"boolean"},letter1:{control:"text"},letter2:{control:"text"},img:{control:"file"},word:{control:"text"},answer:{control:"text"}}},o={args:{option1:"C",option2:"W",option3:"S",option4:"P",option5:"M",isAllowOnlyCorrect:!0,word:"CAT",letter1:"A",letter2:"T",answer:"C"},render:t=>{const i=a(t);return r`<lido-home .xmlData="${i}"></lido-home>`}};function a(t){const{isAllowOnlyCorrect:i=!0}=t;return`<main>
   <lido-container visible="true" id="lido-container" template-id="mcq"  objective="${t.answer}" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/WordBuilding/bgImage.png"  onInCorrect="lido-avatar.avatarAnimate='Fail';this.sleep='2000';" onCorrect="lido-avatar.avatarAnimate='Success';data.speak='true';this.sleep='1200';data.z-index='100'; data.boxShadow='0 0 40px #FFC107';this.sleep='300'; this.sleep='400'; data.boxShadow='none';this.sleep='2000';" is-continue-on-correct="${i}" is-allow-only-correct="true" onEntry="inst.speak='true';blank.z-index='12';">
<!-- Chimple Avatar -->
  ...
  </main>`}var e,n,l;o.parameters={...o.parameters,docs:{...(e=o.parameters)==null?void 0:e.docs,source:{originalSource:`{
  args: {
    option1: "C",
    option2: "W",
    option3: "S",
...
}`,...(l=(n=o.parameters)==null?void 0:n.docs)==null?void 0:l.source}}};const c=["wordBuildingwithoutimg"];export{c as __namedExportsOrder,p as default,o as wordBuildingwithoutimg};
