import"./lit-element-DRlmAcsz.js";import{b as s}from"./lit-html-s0HVm7S4.js";const u={title:"Templates/Balancing",argTypes:{leftValue:{control:"text"},rightValue:{control:"text"},objective:{control:"text"}}},i={args:{leftValue:"10-5",rightValue:"11-2",objective:">"},render:t=>{const e=d(t);return s`<lido-home .xmlData="${e}"></lido-home>`}};function a(t){return t?t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&apos;"):""}function d(t){const e=a(t.objective),o=a(t.leftValue),r=a(t.rightValue);return`
   <main>
    <lido-container visible="true" show-next-button="true" drop-action="move"  objective="${e}"  equationCheck="$#lefthandle1,$#righthandle1" id="lido-container" onCorrect="lido-avatar.avatarAnimate='Success';this.sleep='2000';" show-Check="true" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/background-images/Balancing.png" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" is-continue-on-correct="true">
     <!-- Chimple Avatar -->
    <lido-cell layout="pos" id="pos1" disable-edit="true" value="pos2" height="landscape.396px,portrait.400px" width="landscape.298px,portrait.369px" x="landscape.82%, portrait.32%" y="landscape.63%, portrait.78%" aria-hidden="true" z="1" bg-color="transparent" visible="true" onEntry="">
      ...
      <lido-cell visible="true" height="130px" width="80%" layout="row" onEntry="this.position='relative';" y="landscape.6%,portrait.4%">
        ...
        <lido-image is-slice="true"  height="126px" width="172px" audio="" id="drag2" value="${r}" tab-index="4" visible="true"  x="78%" y="0%" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/balancing/big_fruit.png" type="drag">
          <lido-text font-family="'Baloo Bhai 2'" height="126px" width="120px" audio=""  margin="30px 1px 0px 0px" visible="true" onEntry="this.fontWeight='600';" string="${r}" fontColor="black" font-size="40px"></lido-text>
        </lido-image>
      </lido-cell>
    </lido-container>
   </main>
  `}var l,n,p;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    leftValue: '10-5',
    rightValue: '11-2',
    objective: '>'
...
}`,...(p=(n=i.parameters)==null?void 0:n.docs)==null?void 0:p.source}}};const g=["Balancing"];export{i as Balancing,g as __namedExportsOrder,u as default};
