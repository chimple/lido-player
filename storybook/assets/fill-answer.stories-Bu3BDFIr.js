import"./lit-element-DRlmAcsz.js";import{b as n}from"./lit-html-s0HVm7S4.js";const d={title:"Templates/fillAnswer",argTypes:{firstNum:{control:"text"},operator:{control:"text"},secontNum:{control:"text"},equator:{control:"text"},answer:{control:"text"},option1:{control:"text"},option2:{control:"text"},option3:{control:"text"},option4:{control:"text"},isAllowOnlyCorrect:{control:"boolean"}}},o={args:{firstNum:"3",operator:"+",secontNum:"4",equator:"=",answer:"7",option1:"5",option2:"7",option3:"3",option4:"2",isAllowOnlyCorrect:"true"},render:t=>{const a=l(t);return n`<lido-home .xmlData="${a}"></lido-home>`}};function l(t){return`
    <main>
