import"./lit-element-DByy2wOb.js";import{b as n}from"./lit-html-BGZAEiha.js";const d={title:"Templates/foodJar",argTypes:{firstNum:{control:"text"},operator:{control:"text"},secondNum:{control:"text"},equator:{control:"text"},answer:{control:"text"},option1:{control:"text"},option2:{control:"text"},option3:{control:"text"},option4:{control:"text"},option5:{control:"text"},isAllowOnlyCorrect:{control:"boolean"}}},a={args:{firstNum:"10",operator:"+",secondNum:"5",equator:"=",answer:"15",option1:"=",option2:"5",option3:"+",option4:"15",option5:"10",isAllowOnlyCorrect:"true"},render:t=>{const i=p(t);return n`<lido-home .xmlData="${i}"></lido-home>`}};function p(t){return`
    <main>
