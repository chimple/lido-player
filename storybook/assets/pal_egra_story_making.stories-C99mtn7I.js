import{x as r}from"./lit-html-DLYuhZ0i.js";const p={title:"Templates/StoryMaking",argTypes:{PracticeMode:{control:"boolean"},value1:{control:"text"},value2:{control:"text"},value3:{control:"text"},value4:{control:"text"}}},t={args:{PracticeMode:!1,value1:"A",value2:"D",value3:"E",value4:"B"},render:e=>{const o=s(e);return r`<lido-home .xmlData="${o}"></lido-home>`}};function s(e){return`<main>
    <lido-container disable-speak="true" is-continue-on-correct="true" template-id="dragAndDrop" is-allow-only-correct="true" objective="${e.value1},${e.value2},${e.value3},${e.value4}" onCorrect="lido-avatar.avatarAnimate='Success'; this.sleep='2000';" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/palStory/bgImage.png">
