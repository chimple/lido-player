        ...
        <lido-cell layout="col" visible="true" width="100%" height="100%" bg-color="transparent">
            ...
            <lido-cell layout="landscape.row, portrait.col" visible="true" width="landscape.75%, portrait.76%" height="landscape.57%, portrait.73%" bg-color="white" onEntry="this.borderRadius='10px'; this.padding='8px';" margin="landscape.0 , portrait. -164px 0px -308px">
                ...
                <lido-cell layout="flex" visible="true" height="landscape.100%,portrait.50%" width="landscape.50%, portrait.90%" onEntry="this.align-content='center';this.display='ruby'; this.gap='32px';" margin="landscape.0px 40px 0px 0px, portrait.0">
                    ...
                    <lido-text id="drop1" margin="28px 20px -9px 20px" disable-edit="true" tab-index="3" visible="true" width="164px" height="landscape.73px,portrait.77px" value="${t.answer1}" type="drop" is-AllowOnlyOneDrop="true" onEntry="this.border-radius='10px';this.box-shoadow='';" ></lido-text>
                    ...
                    <lido-text id="drop2" margin="28px 20px -9px 20px" disable-edit="true" tab-index="4" visible="true" width="164px" height="landscape.73px,portrait.77px" value="${t.answer2}" type="drop" isAllowOnlyOneDrop="true" onEntry="this.border-radius='10px';" ></lido-text>
                    ...
                    <lido-text id="drop3" margin="28px 20px -9px 20px"  disable-edit="true" tab-index="5" visible="true" width="164px" height="landscape.73px,portrait.77px" value="${t.answer3}" type="drop" isAllowOnlyOneDrop="true" onEntry="this.border-radius='10px';"></lido-text>
                    ...
                    <lido-text id="drop4" margin="28px 20px -9px 20px"  disable-edit="true" tab-index="6" visible="true" width="164px" height="landscape.73px,portrait.77px" value="${t.answer4}" type="drop" isAllowOnlyOneDrop="true" onEntry="this.border-radius='10px';" ></lido-text>
