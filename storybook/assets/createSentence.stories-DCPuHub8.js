            ...
            <lido-cell id="col" layout="col" disable-edit="true" value="pos" aria-hidden="true" x="0" y="0" z="0" bg-color="transparent" type="" visible="true" audio="" onTouch="" onCorrect="" width="100%" height="100%" onEntry="">
                <lido-cell id="pos2" layout="pos" disable-edit="true" value="pos" aria-hidden="true" x="0" y="0" z="0" bg-color="transparent" type="" visible="true" audio="" onTouch="" width="100%" height="100%" onEntry="this.animation='rightToPlace 2.5s linear'; this.sleep='2000'">
                    ...
                    <lido-cell layout="row" visible="true" width="landscape.47%, portrait.76%" min-length="2" max-length="6" height="landscape.0%, portrait.20%" x="landscape.33%, portrait.17%" y="landscape.56%, portrait.61%" bg-color="transparent" onEntry="">
                        <lido-text visible="true" id="drop1" width="150px" height="80px" value="${t.correct1}" z="1" y="149px" type="drop" tab-index="1" is-allow-only-one-drop="true" onEntry=" this.background='transparent'; this.borderRadius='15px'; this.display='flex'; this.alignItems='center'; this.justifyContent='center'; this.fontWeight='bold';">
                        </lido-text>
                        <lido-text visible="true" id="drop2" width="150px" height="80px" value="${t.correct2}" z="1" y="149px" type="drop" tab-index="2" is-allow-only-one-drop="true" onEntry=" this.background='transparent'; this.borderRadius='15px'; this.display='flex'; this.alignItems='center'; this.justifyContent='center'; this.fontWeight='bold';">
                        </lido-text>
                        <lido-text visible="true" id="drop3" width="150px" height="80px" value="${t.correct3}" z="1" y="149px" type="drop" tab-index="3" is-allow-only-one-drop="true" onEntry=" this.background='transparent'; this.borderRadius='15px'; this.display='flex'; this.alignItems='center'; this.justifyContent='center'; this.fontWeight='bold';">
                        </lido-text>
                        <lido-text visible="true" id="drop4" width="150px" height="80px" value="${t.correct4}" z="1" y="149px" type="drop" tab-index="4" is-allow-only-one-drop="true" onEntry=" this.background='transparent'; this.borderRadius='15px'; this.display='flex'; this.alignItems='center'; this.justifyContent='center'; this.fontWeight='bold';">
                        </lido-text>
                    </lido-cell>
                </lido-cell>
                <lido-cell layout="row" visible="true" width="landscape.70%, portrait.88%" y="landscape.40%, portrait.42%" x="0%" z="2" onEntry="this.position='relative'">
                    <lido-text id="option1" value="${t.option1}" tab-index="5" flexible-width="false" visible="true" bg-color="#6DC1ED" onEntry="this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; this.color='white';" width="150px" height="90px" string="${t.option1}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                    <lido-text id="option2" value="${t.option2}" tab-index="6" flexible-width="false" visible="true" bg-color="#6DC1ED" onEntry="this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; this.color='white';" width="150px" height="90px" string="${t.option2}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                    <lido-text id="option3" value="${t.option3}" tab-index="7" flexible-width="false" visible="true" bg-color="#6DC1ED" onEntry="this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; this.color='white';" width="150px" height="90px" string="${t.option3}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                    <lido-text id="option4" value="${t.option4}" tab-index="8" flexible-width="false" visible="true" bg-color="#6DC1ED" onEntry="this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; this.color='white';" width="150px" height="90px" string="${t.option4}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                </lido-cell>
            </lido-cell>
                <!-- avatar -->
