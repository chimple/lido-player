import"./lit-element-DByy2wOb.js";import{b as s}from"./lit-html-BGZAEiha.js";const u={title:"Templates/Balancing",argTypes:{leftValue:{control:"text"},rightValue:{control:"text"},objective:{control:"text"}}},i={args:{leftValue:"10-5",rightValue:"11-2",objective:">"},render:t=>{const e=d(t);return s`<lido-home .xmlData="${e}"></lido-home>`}};function a(t){return t?t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&apos;"):""}function d(t){const e=a(t.objective),o=a(t.leftValue),r=a(t.rightValue);return`
   <main>
