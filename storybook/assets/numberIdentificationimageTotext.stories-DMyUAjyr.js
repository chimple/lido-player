import"./lit-element-DRlmAcsz.js";import{b as n}from"./lit-html-s0HVm7S4.js";const c={title:"Templates/numberIdentificationimageTotext",argTypes:{option1:{control:"text"},option2:{control:"text"},option3:{control:"text"},option4:{control:"text"},question:{control:"text"},answers:{control:"text"},row:{control:"text"},col:{control:"text"},PracticeMode:{control:"boolean"}}},e={args:{PracticeMode:!1,option1:"3",option2:"2",option3:"7",option4:"8",row:"4",col:"2",question:"EIGHT",answer:"8"},render:t=>{const r=l(t);return n`<lido-home .xmlData="${r}"></lido-home>`}};function l(t){return`<main>
