import"./lit-element-BxxbMms4.js";import{x as c}from"./lit-html-DLYuhZ0i.js";const g={title:"Templates/palEgraBuildWord",argTypes:{options:{control:"object"},PracticeMode:{control:"boolean"}}},i={args:{question_text:"Listen to the word and build it with the letters below",question_word:["dance"],PracticeMode:!1},render:t=>{const o=h(t);return c`<lido-home .xmlData="${o}"></lido-home>`}};function h(t){const o=t.question_word[0],r=[...o],n=r.map((a,e)=>`
