import"./lit-element-DRlmAcsz.js";import{b as x}from"./lit-html-s0HVm7S4.js";const g={title:"Templates/writeLetter",argTypes:{traceImage:{control:"file",name:"Trace Image URL",multiple:!0},traceMode:{control:"select",options:["noFlow","showFlow","freeTrace","blindTracing","blindFreeTrace"],name:"Trace Mode"},flashCardImage:{control:"file",name:"Flash Card Image URL",multiple:!0},frontSlot:{control:"select",options:["front","back"],name:"Flash Card Front Slot"},backSlot:{control:"select",options:["front","back"],name:"Flash Card Back Slot"},frontText:{control:"text",name:"Flash Card Front Text"},backText:{control:"text",name:"Flash Card Back Text"},isAllowOnlyCorrect:{control:"boolean",name:"Allow Only Correct"}},args:{traceImage:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/trace/hindi_aa.svg"],traceMode:"showFlow",flashCardImage:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/flash-card/Unicorn.png"],frontSlot:"front",backSlot:"back",frontText:"Unicorn is cute and shy",backText:'I am a colour. I am mentioned in the poem along with Yellow and Blue. My name starts with the letter "R". Who am I?',isAllowOnlyCorrect:!0}},a={args:{frontSlot:"front",backSlot:"back",frontText:"Unicorn is cute and shy",backText:"I am a colour. I am mentioned in the poem along with Yellow and Blue. My name starts with the letter 'R'. Who am I?"},render:t=>{const e=b(t);return x`<lido-home xml-data="${e}" xmlData="${e}"></lido-home>`}};function b(t){const e=t.traceImage[0],s=t.traceMode,r=t.flashCardImage[0],p=t.frontSlot,c=t.backSlot,d=t.frontText,h=t.backText,o=t.isAllowOnlyCorrect??!0;return!e||!r?(console.error("Trace image or flash card image is missing"),""):`
        <main>

            <lido-container  id="lido-container" disableSpeak="true" objective="writeLetter" tab-index="1"  value="mainContainer1" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/background-images/Write%20letter.png" height="100%" width="100%" bg-Color="transparent"  visible="true"   onCorrect="lido-avatar.avatarAnimate='Success'; this.sleep='2000';" onEntry="this.justifyContent='space-around';" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" show-check="false" is-continue-on-correct="true" is-allow-only-correct="${o}" after-drop="false">
                ...
                <lido-cell  layout="landscape.row, portrait.col" visible="true" width="100%" height="100%" bg-color="transparent">
                    ...
                    <lido-cell tab-index="2" layout="col" show-speak-icon="true" audio="" visible="true" width="landscape.725px, portrait.725px"  height="landscape.725px, portrait.725px" bg-color="#0A2C45"  onEntry="this.border-radius='6px'; this.flex-shrink='0';">
                        <lido-trace id="image2" tab-index="3" value="a" visible="true" svg-source="${e}" onCorrect="this.speak='true';"  mode="${s}" z="1" x="25px" y="25px" width="landscape.700px,portrait.700px" height="landscape.700px,portrait.700px" alt-text="{backgroundImage}">
                        </lido-trace>
                    </lido-cell>
            ...
            <lido-container id="lido-container" objective="writeCard" tab-index="1"  value="mainContainer1" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/background-images/Write%20letter.png"  height="1600px" width="900px" bg-color="transparent"  visible="true"   onCorrect="lido-avatar.avatarAnimate='Success'; this.sleep='2000';" onEntry="this.justifyContent='space-around';" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" show-check="false" is-continue-on-correct="true" is-allow-only-correct="${o}" after-drop="false">
                ...
                <lido-cell layout="pos" id="pos2" disable-edit="true" value="pos2" width="landscape.594px, portrait.754px" height="landscape.725px, portrait.925px" x="landscape.519px, portrait.73px" y="landscape.127px, portrait.172px" aria-hidden="true" z="1" bg-color="transparent" visible="true"  onEntry="this.flex-shrink='0';">
                    <lido-flash-card x="50" y="100" width="landscape.594px, portrait.754px" height="landscape.725px, portrait.925px" bg-color="transparent" onEntry="this.border-radius='32px';" onTouch="">
                        <lido-cell layout="col" show-speak-icon="true" audio="" id="col1" slot="${p}" disable-edit="true" visible="true" width="landscape.594px, portrait.754px" height="landscape.725px, portrait.925px" bg-color="white" type="" tab-index="2" dropAttr="diagonal" onEntry="this.border-radius=32px; this.padding='8px 8px 16px 8px';" y="landscape.5px,portrait.10px">
                            ...
                            <lido-text id="txt1" width="553px" height="80px" display="flex" onEntry="this.textAlign='center'; this.flexDirection='column'; this.justifyContent='center'; this.alignItems='center'; this.flexShrink='0';" font-family="'Baloo Bhai 2'" font-size="52px" z="1" font-color="black" font-weight="500" color="#303030" string="${d}" visible="true" y="landscape.15px, portrait.15px" bg-color="white" margin="landscape.45px 0px 45px 0px, portrait.45px 0px 45px 0px">
                            </lido-text>
                        </lido-cell>
                        <lido-cell layout="col" id="col2" show-speak-icon="true" audio="" slot="${c}" disable-edit="true" visible="true"  width="landscape.594px, portrait.754px" height="landscape.725px, portrait.925px" bg-color="white" type="" tab-index="3" dropAttr="diagonal" onEntry="this.border-radius=32px; this.padding='8px 8px 16px 8px';" y="landscape.,portrait.">
                            <lido-text id="txt2" height="480px" width="495px" display="flex" onEntry="this.textAlign='left'; this.lineHeight='1.5';" font-family="'Baloo Bhai 2'" font-size="52px" z="1" font-color="black" font-weight="500" color="#000000" string="${h}" visible="true" y="landscape.35px, portrait.15px" bg-color="white" margin="landscape.45px 0px 45px 0px, portrait.45px 0px 45px 0px">
                            </lido-text>
                        </lido-cell>
                    </lido-flash-card>
                </lido-cell>
...
}`,...(n=(l=a.parameters)==null?void 0:l.docs)==null?void 0:n.source}}};const f=["WriteCard"];export{a as WriteCard,f as __namedExportsOrder,g as default};
