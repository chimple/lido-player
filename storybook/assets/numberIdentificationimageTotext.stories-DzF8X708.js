import"./lit-element-BxxbMms4.js";import{x as n}from"./lit-html-DLYuhZ0i.js";const c={title:"Templates/numberIdentificationimageTotext",argTypes:{option1:{control:"text"},option2:{control:"text"},option3:{control:"text"},option4:{control:"text"},question:{control:"text"},answers:{control:"text"},row:{control:"text"},col:{control:"text"},PracticeMode:{control:"boolean"}}},e={args:{PracticeMode:!1,option1:"3",option2:"2",option3:"7",option4:"8",row:"4",col:"2",question:"EIGHT",answer:"8"},render:t=>{const r=l(t);return n`<lido-home .xmlData="${r}"></lido-home>`}};function l(t){return`<main>
 <lido-container  visible="true" id="lido-container" template-id="mcq" onInCorrect="lido-avatar.avatarAnimate='Fail';this.sleep='2000';" onCorrect="lido-avatar.avatarAnimate='Success';this.sleep='2300';" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/pal_number_identification/bgImage.png" objective="${t.answer}"  is-continue-on-correct="${t.PracticeMode}" is-allow-only-correct="${t.PracticeMode}" onEntry="inst.speak='true';question.speak='true';text1.speak='true';text2.speak='true';text3.speak='true';text4.speak='true';">
     <!-- Chimple Avatar -->
...
<!-- question text -->
        <lido-cell layout="row" visible="true" margin="landscape.26px 0px 155px 0px, portrait.-170px 0px 0px 0px" height="290px" width="landscape.1355PX,portrait.100%" bg-color="#FFF5BB" onEntry="this.justifyContent='space-around';this.border='2px solid #FFA500'; this.borderRadius='16px';this.gap='0px';">
            <lido-text id="question" tab-index="2" visible="true" value="10" string="${t.question}" font-family="'Baloo Bhai 2'" font-color="black" font-size="landscape.140px, portrait.84px"  bg-color="transparent" 
        ...
        <lido-cell layout="landscape.row, portrait.col" visible="true" margin="landscape.-65px 0px -101px -94px,portrait.0" onEntry="this.border-radius='26px';" height="landscape.390px,portrait.46%" width="landscape.76%,portrait.100%" bg-color="transparent">
                ...
                <lido-cell layout="row" visible="true" margin="" onEntry="this.border-radius='24px';" height="228px" width="landscape.280px,portrait.300px" bg-color="orange"  type="click" value="${t.option1}">
                    ...
                    <lido-text id="text1" tab-index="3" disable-speak="true" visible="true"  string="${t.option1}" font-family="'Baloo Bhai 2'" font-color="black" font-size="landscape.140px, portrait.100px"  bg-color="orange" 
                    onEntry="this.fontWeight='700';">
                    </lido-text>
                </lido-cell>
...
}`,...(a=(i=e.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const d=["numberIdentificationimageTotext"];export{d as __namedExportsOrder,c as default,e as numberIdentificationimageTotext};
