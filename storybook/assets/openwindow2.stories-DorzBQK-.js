import"./lit-element-DRlmAcsz.js";import{b as p}from"./lit-html-s0HVm7S4.js";const g={title:"Templates/OpenWindowUI2",argTypes:{objective:{control:"text"},heading:{control:"text"},backgroundImage:{control:"file",name:"Background Image URL",multiple:!0},choice1Text:{control:"text",name:"Choice 1 Text"},choice1ImageUrl:{control:"file",name:"Choice 1 Image URL",multiple:!0},choice2Text:{control:"text",name:"Choice 2 Text"},choice2ImageUrl:{control:"file",name:"Choice 2 Image URL",multiple:!0},isAllowOnlyCorrect:{control:"boolean",name:"Allow Only Correct"}},args:{objective:"city",heading:"CITY",backgroundImage:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/open_window/Spring.png"],choice1Text:"city",choice1ImageUrl:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/open_window/city.png"],choice2Text:"sun",choice2ImageUrl:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/open_window/sun.png"],isAllowOnlyCorrect:!0}},i={args:{objective:"mom",heading:"MOM",choice2Text:"mom",choice2ImageUrl:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/open_window/mom.png"]},render:e=>{const t=d(e);return p`<lido-home xml-data="${t}" .xmlData="${t}"></lido-home>`}};function d(e){const t=[{id:"choice1",value:e.choice1Text,src:e.choice1ImageUrl[0]},{id:"choice2",value:e.choice2Text,src:e.choice2ImageUrl[0]}],c=e.isAllowOnlyCorrect??!0,r=t.map(o=>`
      ...
      `).join(`
`),a="heading.speak='true'; this.sleep='800';";return`
  <main>
    <lido-container id="lido-container" tab-index="1" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/background-images/Open%20window.png" height="100%" width="100%" visible="true" is-continue-on-correct="true" is-allow-only-correct="${c}" onCorrect="${a} lido-avatar.avatarAnimate='Success'; this.sleep='2000';" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" onEntry="${a}" objective="${e.objective}" >
    ...
    <lido-container id="lido-container" tab-index="1" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/background-images/Open%20window.png" height="100%" width="100%" visible="true" is-continue-on-correct="true" onCorrect="${a} lido-avatar.avatarAnimate='Success'; this.sleep='2000';" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" onEntry="${a}" objective="${e.objective}" >
      <lido-cell layout="row" visible="true" width="landscape.auto, portrait.80%" height="landscape.30%, portrait.10%" bg-color="transparent" margin="5%" onEntry="">
        <lido-text id="heading" tab-index="2" visible="true" border-image="" bg-color="transparent" width="350px" height="210px" string="${e.heading}" font-color="black" font-family="'Baloo 2', serif" font-size="146px" z="0"
        onEntry="this.borderRadius='6px'; this.boxShadow='unset'; this.fontWeight='800';"  audio="">
        </lido-text>
...
}`,...(n=(s=i.parameters)==null?void 0:s.docs)==null?void 0:n.source}}};const m=["OpenWindow"];export{i as OpenWindow,m as __namedExportsOrder,g as default};
