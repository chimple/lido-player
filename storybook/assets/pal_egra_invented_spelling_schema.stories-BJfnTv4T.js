import{b as a}from"./lit-html-BGZAEiha.js";const p={title:"Templates/InventedSpelling",argTypes:{PracticeMode:{control:"boolean"},option1:{control:"text"},option2:{control:"text"},option3:{control:"text"},option4:{control:"text"},option5:{control:"text"},correctAns:{control:"text"}}},e={args:{PracticeMode:!1,option1:"kot",option2:"loy",option3:"fen",option4:"dob",option5:"vil",correctAns:"toy"},render:t=>{const l=n(t);return a`<lido-home .xmlData="${l}"></lido-home>`}};function n(t){return`<main>
