import"./lit-element-DByy2wOb.js";import{b as s}from"./lit-html-BGZAEiha.js";const x={title:"Templates/palEgra_OddOneOut",argTypes:{options:{control:"object"},PracticeMode:{control:"boolean"}}},a={args:{question_text:"विषम का चयन कीजिये",options:["तन","@नर","मन","जन"],PracticeMode:!1},render:e=>{const i=p(e);return s`<lido-home .xmlData="${i}"></lido-home>`}};function p(e){const i=e.options.map((t,o)=>`
