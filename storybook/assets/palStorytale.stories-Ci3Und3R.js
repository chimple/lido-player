import"./lit-element-BxxbMms4.js";import{x as l}from"./lit-html-DLYuhZ0i.js";const d={title:"Templates/palStorytale"},t={args:{content:"One hot day, a crow was very thirsty.It flew here and there looking for water. At last, it found a pitcher with a little water at the bottom. The crow tried to drink but could not reach the water. Then the crow had an idea. It dropped small stones into the pitcher. Slowly, the water rose up. The crow drank the water and flew away happily."},render:e=>{const i=n(e);return l`<lido-home .xmlData="${i}"></lido-home>`}};function n(e){return`<main>
    <lido-container show-prev-button="false" show-next-button="true" id="lido-container" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/palStory/bgImage.png" height="1600px" width="900px" value="mainContainer4" objective="" aria-label="" x="0" y="0" z="0" visible="true" audio="" onTouch="" onCorrect="" onEntry="" onInCorrect="lido-avatar.avatarAnimate='Success'; this.sleep='2000';" show-check="false" is-continue-on-correct="true">
        <lido-cell layout="row" id="cell1" visible="true" margin="99px 164px 0px 0px"  value="cell1" width="landscape.87%,portrait.86%" height="landscape.76%,portrait.80%" x="50px" y="50px" bg-color="transparent"  onEntry="" >
            ...
            <lido-text id="text1" tab-index="1"   value="text1" visible="true" width="landscape.100%,portrait.90%" height="100%" bg-color="#FFF5BB" font-family="Baloo Bhai 2" font-size="60px" font-color="#000" string='${e.content}' onEntry="this.border='2px solid #FFB612'; this.fontWeight='600';this.padding='20px 28px'; this.boxShadow='unset'; this.border-radius='16px'; this.textAlign='start'; this.speak='true';">
            </lido-text>
        </lido-cell>
    ...
    </main>`}var a,r,o;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
...
}`,...(o=(r=t.parameters)==null?void 0:r.docs)==null?void 0:o.source}}};const h=["AmazingStories"];export{t as AmazingStories,h as __namedExportsOrder,d as default};
