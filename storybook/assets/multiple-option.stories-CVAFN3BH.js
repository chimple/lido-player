import{x as n}from"./lit-html-DLYuhZ0i.js";const l={title:"Templates/MultiOption",argTypes:{question:{control:"text"},option1:{control:"text"},optionImg1:{control:"text"},option2:{control:"text"},optionImg2:{control:"text"},option3:{control:"text"},optionImg3:{control:"text"},option4:{control:"text"},optionImg4:{control:"text"},correctAns:{control:"text"}}},i={args:{question:"Which animal is known as “the king of the jungle”?",option1:"GIRAFFE",optionImg1:"https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/temp1/giraffe.png",option2:"LEOPARD",optionImg2:"https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/temp1/leopard.png",option3:"LION",optionImg3:"https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/temp1/lion.png",option4:"TIGER",optionImg4:"https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/temp1/tiger.png",correctAns:"LION"},render:t=>{const a=r(t);return n`<lido-home .xmlData="${a}}"></lido-home>`}};function r(t){return`<main>
    <lido-container id="lido-container" customStyle=".redBg{background-color: red !important;} .greenBg{background-color: green !important; color: white !important;}" tab-index="1" value="maincontainer" objective="${t.correctAns}" aria-label="This is a multiple-option question. Select one option from the list." height="100vh" width="100vw" x="0" y="0" z="0" bg-color="transparent" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/temp1/MultipleOptionBg.png" visible="true" audio="background1.mp3" onTouch="" onCorrect="lido-avatar.avatarAnimate='Success'; this.sleep='2000';" onEntry="" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" show-check="false" is-continue-on-correct="true">
        ...
        <lido-pos id="question" value="pos2" visible="true" height="150px" width="1050px" bg-color="transparent" z="0" x="260px" y="80px" onEntry="this.animation='topToPlace 0.5s linear';">
            ...
            <lido-text id="textA" tab-index="2" value="{question.id}" visible="true" width="1000px" height="100px" onEntry="this.boxShadow='unset'; this.fontWeight='800'; this.marginBottom='50px';" string="${t.question}" font-family="'Baloo 2', serif" font-size="40px" font-color="black" bg-color="transparent" z="0" x="25px" y="20px">
            </lido-text>
        </lido-pos>
        <!-- Options -->
        <lido-pos id="pos3" disable-edit="true" value="pos3" visible="true" height="0" width="" bg-color="transparent" x="" y="" z="1" onEntry="this.animation='bottomToPlace 1s linear'; this.display='grid'; this.placeItems='center';">
            ...
            <lido-row id="row" value="row" visible="true" width="auto" height="260px" bg-color="transparent" y="425px" onEntry="this.gap='20px';">
                    <lido-col id="option1" value="${t.option1}" visible="true" width="auto" height="230px" type="click" onEntry="this.border='3px solid #F3A040'; this.borderRadius='24px'; " onInCorrect="this.border='8px solid red';" onCorrect=" this.border='8px solid #65BC46';" bg-color="#FFAC4C">
                        <lido-image id="{options[0].id}" tab-index="3" value="image4" visible="true" width="170px" height="170px" src="${t.optionImg1}" bg-color="transparent" onEntry="this.marginTop='5px';" alt-text="{option[0].image}">
                        </lido-image>
                        <lido-text id="{options[0].id}" tab-index="4" value="{options[0].id}" visible="true" width="220px" flexible-width="false" font-family="'Baloo 2', serif"  font-size="36px" font-color="black" string="${t.option1}" bg-color="white" onEntry="this.boxShadow='unset'; this.fontWeight='800'; this.borderRadius='20px'; this.marginTop='10px';">
                        </lido-text>
                    </lido-col>
                    ...
                    this.transform= 'scale(1.05)';" bg-color="#FFAC4C"> 
                        <lido-image id="{options[1].id}" tab-index="5" value="image5" visible="true" width="170px" height="170px" src="${t.optionImg2}" bg-color="transparent" onEntry="this.marginTop='5px';" alt-text="{options[1].image}">
                        </lido-image>
                        <lido-text id="{options[1].id}" tab-index="6" value="{options[1].id}" visible="true" width="220px" flexible-width="false" font-family="'Baloo 2', serif" font-size="36px" font-color="black" string="${t.option2}" bg-color="white" onEntry="this.boxShadow='unset'; this.fontWeight='800'; this.borderRadius='20px'; this.marginTop='10px';">
                        </lido-text>
                    </lido-col>
                    <lido-col id="option3" value="${t.option3}" visible="true" width="auto" height="230px" type="click" onEntry="this.border='3px solid #F3A040'; this.borderRadius='24px';" onInCorrect="this.border='8px solid red';" onCorrect="this.border='8px solid #65BC46';" bg-color="#FFAC4C">
                        <lido-image id="{options[2].id}" tab-index="7" value="image6" visible="true" width="170px" height="170px" src="${t.optionImg3}" bg-color="transparent" onEntry="this.marginTop='5px';" alt-text="{option[2].image}">
                        </lido-image>
                        <lido-text id="{options[2].id}" tab-index="8" value="{options[2].id}" visible="true" width="220px" flexible-width="false" font-family="'Baloo 2', serif" font-size="36px" font-color="black" string="${t.option3}" bg-color="white" onEntry="this.boxShadow='unset'; this.fontWeight='800'; this.borderRadius='20px'; this.marginTop='10px';">
                        </lido-text>
                    </lido-col>
                    <lido-col id="option4" value="${t.option4}" visible="true" width="auto" height="230px" type="click" onEntry="this.border='3px solid #F3A040'; this.borderRadius='24px';" onInCorrect="this.border='8px solid red';" onCorrect="this.border='8px solid #65BC46';" bg-color="#FFAC4C">
                        <lido-image id="{options[3].id}" tab-index="9" value="image7" visible="true" width="170px" height="170px" src="${t.optionImg4}" bg-color="transparent" onEntry="this.marginTop='5px';" alt-text="{options[3].image}">
                        </lido-image>
                        <lido-text id="{options[3].id}" tab-index="10" value="{options[3].id}" visible="true" width="220px" flexible-width="false" font-family="'Baloo 2', serif" font-size="36px" font-color="black" string="${t.option4}" bg-color="white" onEntry="this.boxShadow='unset'; this.fontWeight='800'; this.borderRadius='20px'; this.marginTop='10px';">
                        </lido-text>
                    </lido-col>
            </lido-row>
        </lido-pos>
    </lido-container>
</main>`}var o,e,s;i.parameters={...i.parameters,docs:{...(o=i.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
...
}`,...(s=(e=i.parameters)==null?void 0:e.docs)==null?void 0:s.source}}};const d=["Default"];export{i as Default,d as __namedExportsOrder,l as default};
