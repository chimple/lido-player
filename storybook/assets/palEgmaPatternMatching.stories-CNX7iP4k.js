import"./lit-element-BxxbMms4.js";import{x as u}from"./lit-html-DLYuhZ0i.js";const g={title:"Templates/palEgmaPatternMatching",argTypes:{options:{control:"object"},answers:{control:"object"},PracticeMode:{control:"boolean"}}},o={args:{question_text:"Complete the pattern",questions:["975","976","@977","978","979"],options:["977","980","957","947"],PracticeMode:!1},render:e=>{const r=h(e);return u`<lido-home .xmlData="${r}"></lido-home>`}};function h(e){const r=e.questions.map((t,a)=>{const i=t==null?void 0:t.startsWith("@"),c=i?t.slice(1):t,d=i?"_":t,x=a<e.questions.length-1;return`
