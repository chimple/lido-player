import"./lit-element-DByy2wOb.js";import{b as c}from"./lit-html-BGZAEiha.js";const p={title:"Templates/Categorize",argTypes:{options:{control:"object"},category1:{control:"text"},category2:{control:"text"},category3:{control:"text"},correct1:{control:"text"},correct2:{control:"text"},correct3:{control:"text"}}},e={args:{options:["Apple","Lion","Tiger","3","Strawberry","7","Mango","10"],category1:"Fruits",category2:"Numbers",category3:"Animals",correct1:"Apple,Strawberry,Mango",correct2:"3,7,10",correct3:"Lion,Tiger"},render:t=>{const o=s(t);return c`<lido-home .xmlData="${o}"></lido-home>`}};function s(t){return`
  <main>
