import"./lit-element-DRlmAcsz.js";import{b as u}from"./lit-html-s0HVm7S4.js";const g={title:"Templates/palEgmaPatternMatching",argTypes:{options:{control:"object"},answers:{control:"object"},PracticeMode:{control:"boolean"}}},o={args:{question_text:"Complete the pattern",questions:["975","976","@977","978","979"],options:["977","980","957","947"],PracticeMode:!1},render:e=>{const r=h(e);return u`<lido-home .xmlData="${r}"></lido-home>`}};function h(e){const r=e.questions.map((t,a)=>{const i=t==null?void 0:t.startsWith("@"),c=i?t.slice(1):t,d=i?"_":t,x=a<e.questions.length-1;return`
  <lido-text id="pattern${1+a}"
    visible="true"
    tab-index="${1+a}"
    value="${c}"
    string="${d}"
  ...
  `:""}
`}).join(""),p=e.options.map((t,a)=>`
      <lido-cell layout="row" id="text${1+a}" visible="true" margin="" onEntry="this.border-radius='14px';" height="landscape.270px,portrait.244px" width="landscape.270px,portrait.244px" bg-color="orange"  type="click" value="${t}">
...
`}var l,n,s;o.parameters={...o.parameters,docs:{...(l=o.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
...
}`,...(s=(n=o.parameters)==null?void 0:n.docs)==null?void 0:s.source}}};const v=["palEgmaPatternMatching"];export{v as __namedExportsOrder,g as default,o as palEgmaPatternMatching};
