import"./lit-element-BxxbMms4.js";import{x}from"./lit-html-DLYuhZ0i.js";const v={title:"Templates/RocketGame",argTypes:{correct:{control:"object",description:"Array of correct letter",defaultValue:["h","i","t"]},options:{control:"object",description:"Array of option letters",defaultValue:["a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"]},TextBackgroundImage:{control:"file",description:"Background image for HIT text",defaultValue:"https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/RocketAssets/Fullalphabet/hit_img_1.png",multiple:!0},letterBoardText:{control:"text",description:'The word to display (e.g. "HIT")',defaultValue:"HIT"},dropImage:{control:"file",description:"Drop slot for letter",defaultValue:"https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/RocketAssets/Fullalphabet/dropImag.svg",multiple:!0},backgroundImage:{control:"file",description:"Main background image",defaultValue:"https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/trace/Sky.png",multiple:!0},colors:{control:"object",description:"Array of colors for the letters",defaultValue:["#F34D08","#81C127","#FFC805","#F55376","#5D44BD"]}},args:{correct:["h","i","t"],options:["k","q","d","x","a","p","g","l","w","i","f","m","e","z","j","o","b","n","h","t","s","v","r","c","y","u"],TextBackgroundImage:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/RocketAssets/Fullalphabet/hit_img_1.png"],letterBoardText:"HIT",dropImage:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/RocketAssets/Fullalphabet/dropImag.svg"],backgroundImage:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/RocketAssets/Fullalphabet/Background_Sky.png"],colors:["#F34D08","#81C127","#FFC805","#F55376","#5D44BD"]}},r={render:t=>{const i=f(t);return x`<lido-home xml-data="${i}" xmlData="${i}"></lido-home>`}};function f(t){const i=t.options.slice(0),g=16,s=t.colors,h=t.correct.join(","),o=t.correct.length,n=46+o*4,l=o<=3?52+o*4:56+o*4,b=t.correct.map((e,a)=>`
  ...
  <main> 
      ...
      <lido-container id="lido-container" objective="${h}" show-drop-border="false" tab-index="1" is-allow-only-correct="true" is-continue-on-correct="true" onCorrect="fullRrocket.animation='placeToLeft 2.5s 1s linear'; this.sleep='1000'; heading.speak='true'; " show-check="false" bg-image="${t.backgroundImage}" visible="true" onEntry="this.overflowY='hidden'; this.overflowX='hidden'; this.background-color='transparent';" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" after-drop="false" drop-action="infinite-drop">
...
}`,...(c=(d=r.parameters)==null?void 0:d.docs)==null?void 0:c.source}}};const w=["Rocket"];export{r as Rocket,w as __namedExportsOrder,v as default};
