import{x as n}from"./lit-html-DLYuhZ0i.js";const p={title:"Templates/MCQWithQuestionImage",argTypes:{question:{control:"text"},questionImg:{control:"text"},option1:{control:"text"},audio1:{control:"text"},optionImg1:{control:"text"},audio2:{control:"text"},option2:{control:"text"},optionImg2:{control:"text"},option3:{control:"text"},audio3:{control:"text"},optionImg3:{control:"text"},option4:{control:"text"},audio4:{control:"text"},optionImg4:{control:"text"},correctAns:{control:"text"}}},o={args:{question:"I have less than double of 3 marbles. I have more than half of 8 marbles. How many marbles do I have?",questionImg:"https://aeakbcdznktpsbrfsgys.storage.supabase.co/v1/object/public/template-assets/fill-in-the-blanks/image%201.png",option1:"A square and a circle",audio1:"",optionImg1:"",option2:"A square and a rectangle",audio2:"",optionImg2:"",option3:"A triangle and a square",audio3:"",optionImg3:"",option4:"A circle and a rectangle",audio4:"",optionImg4:"",correctAns:"A square and a rectangle"},render:t=>{const e=l(t);return n`<lido-home .xmlData="${e}}"></lido-home>`}};function l(t){const e=t.questionImg===""?"":`<lido-image visible="true" bg-color="white" height="landscape.80%, portrait.35%" src="${t.questionImg}" border-radius="6px" onEntry="this.border='5px solid white';"></lido-image>`;return`<main>
        ...
        <lido-cell visible="true" layout="col" width="100%" height="100%" bg-color="transparent">
            ...
            <lido-text visible="true" width="landscape.65%, portrait.80%" height="10%" bg-color="#FFF5BB" string="I have less than double of 3 marbles. I have more than half of 8 marbles. How many marbles do I have?" border-radius="16px" onEntry="this.border='1px solid black'; this.fontWeight='500'; this.padding='50px';" font-size="36px"></lido-text>
            <lido-cell visible="true" width="68%" height="landscape.68%, portrait.90%" bg-color="transparent" layout="landscape.row, portrait.col"  margin="landscape.0, portrait.-108px 0 0 0">
                    ...
                    <lido-cell visible="true" layout="wrap" width="landscape.40%, portrait.80%" height="landscape.97%, portrait.auto" bg-color="transpernt" gap="40px" onEntry="" margin="landscape.0, portrait.-195px 0 0 0">
                            ...
                            <lido-cell visible="true" layout="col" width="100%" type="click" audio="${t.audio1}" value="${t.option1}" height="landscape.250px, portrait.250px" onEntry="this.borderRadius='25px'; this.padding='0';" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" onTouch="this.speak='true';">
                                ${t.optionImg1===""?"":`<lido-image visible="true" src="${t.optionImg1}" bg-color="transparent" width="90%" height="auto" border-radius="25px 25px 0 0" onEntry="this.marginTop='10px';"></lido-image>`}
                            ...
                            <lido-cell visible="true" layout="col" width="100%" type="click" audio="${t.audio2}" value="${t.option2}" height="landscape.250px, portrait.250px" onEntry="this.borderRadius='25px'; this.padding='0';" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" onTouch="this.speak='true';">
                                ${t.optionImg2===""?"":`<lido-image visible="true" src="${t.optionImg2}" bg-color="transparent" width="90%" height="auto" border-radius="25px 25px 0 0" onEntry="this.marginTop='10px';"></lido-image>`}
                            ...
                            <lido-cell visible="true" layout="col" width="100%" type="click" audio="${t.audio3}" value="${t.option3}" height="landscape.250px, portrait.250px" onEntry="this.borderRadius='25px'; this.padding='0';" margin="landscape.0, portrait.20px 0 0 0" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" onTouch="this.speak='true';">
                                ${t.optionImg3===""?"":`<lido-image visible="true" src="${t.optionImg3}" bg-color="transparent" width="90%" height="auto" border-radius="25px 25px 0 0" onEntry="this.marginTop='10px';"></lido-image>`}
                            ...
                            <lido-cell visible="true" layout="col" width="100%" type="click" audio="${t.audio4}" value="${t.option4}" height="landscape.250px, portrait.250px" onEntry="this.borderRadius='25px'; this.padding='0';" margin="landscape.0, portrait.20px 0 0 0" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" onTouch="this.speak='true';">
                                ${t.optionImg4===""?"":`<lido-image visible="true" string="${t.option4}" bg-color="transparent" width="90%" height="auto" border-radius="25px 25px 0 0" onEntry="this.marginTop='10px';"></lido-image>`}
                                <lido-text visible="true" font-size="36px" font-color="black" string="A circle and a rectangle" width="fit-content" bg-color="transparent" onEntry="this.fontWeight='500'; this.padding='0 20px';"></lido-text>
                            </lido-cell>
