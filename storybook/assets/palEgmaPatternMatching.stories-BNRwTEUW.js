import"./lit-element-DByy2wOb.js";import{b as u}from"./lit-html-BGZAEiha.js";const g={title:"Templates/palEgmaPatternMatching",argTypes:{options:{control:"object"},answers:{control:"object"},PracticeMode:{control:"boolean"}}},o={args:{question_text:"Complete the pattern",questions:["975","976","@977","978","979"],options:["977","980","957","947"],PracticeMode:!1},render:e=>{const r=h(e);return u`<lido-home .xmlData="${r}"></lido-home>`}};function h(e){const r=e.questions.map((t,a)=>{const i=t==null?void 0:t.startsWith("@"),c=i?t.slice(1):t,d=i?"_":t,x=a<e.questions.length-1;return`
