import"./lit-element-DRlmAcsz.js";import{b as n}from"./lit-html-s0HVm7S4.js";const d={title:"Templates/quizLiteracy",argTypes:{option1:{control:"text"},option2:{control:"text"},option3:{control:"text"},option4:{control:"text"},text:{control:"text"},answers:{control:"text"}}},i={args:{option1:"Hippopotamus",option2:"Grandmother",option3:"Elephant",option4:"Sunflower",text:"Elephant",answers:"Elephant",image:"https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/template/audioIcon.png"},render:t=>{const e=p(t);return n`<lido-home .xmlData="${e}"></lido-home>`}};function p(t){let e=1;return`<main>
   <lido-container id="lido-container" value="maincontainer" visible="true" objective="${t.answers}"  bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/background-images/Quiz%20literacy.png"  onEntry="" is-Continue-On-Correct="true" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" onCorrect="lido-avatar.avatarAnimate='Success'; this.sleep='2000';">
    ...
    <lido-cell layout="col" visible="true" bg-Color="transparent" width="90%" height="53%" margin="landscape.-177px 0px 0px 0px,portrait.-467px 0px -149px">
  ...
  ${t.text&&t.text.length>0?`<lido-text visible="true" id="answer${e}"  
        ...
        <lido-cell layout="landscape.wrap,portrait.col" visible="true"  margin="landscape.0px,portrait.0px 0px 0px 0px" width="landscape.88%,portrait.77%" height="216px" bg-Color="transparent" onEntry="this.gridTemplateColumns = 'repeat(2, 1fr)';  this.gridTemplateRows = 'repeat(2, 1fr)';this.align-items='center'; this.justify-content='center'; this.gap='40px';">
            ...
            <lido-text visible="true" audio="" onCorrect="this.border='5px solid green';this.cellBorderAnimate='#65BC46';" onInCorrect="this.vibrate='horizontal-shake';" id="drag${e}" tab-index="${e++}" font-size="100px" border-radius="12px" font-color="black" height="205px" width="auto" string="${t.option1}" value="${t.option1}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
              <lido-text visible="true" audio="" onCorrect="this.border='5px solid green';" onInCorrect="this.vibrate='horizontal-shake';" id="drag${e}" tab-index="${e++}" font-size="100px" border-radius="12px" font-color="black" height="205px" width="auto" string="${t.option2}" value="${t.option2}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
              <lido-text visible="true" audio="" onCorrect="this.border='5px solid green';" onInCorrect="this.vibrate='horizontal-shake';"  id="drag${e}" tab-index="${e++}" font-size="100px" border-radius="12px" font-color="black" height="205px" width="auto" string="${t.option3}" value="${t.option3}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
              <lido-text visible="true" audio="" onCorrect="this.border='5px solid green';" onInCorrect="this.vibrate='horizontal-shake';"   id="drag${e}" tab-index="${e++}" font-size="100px" border-radius="12px" font-color="black" height="205px" width="auto" string="${t.option4}" value="${t.option4}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
...
}`,...(r=(a=i.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};const c=["quizLiteracy"];export{c as __namedExportsOrder,d as default,i as quizLiteracy};
