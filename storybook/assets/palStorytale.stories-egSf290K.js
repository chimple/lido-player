import"./lit-element-DRlmAcsz.js";import{b as l}from"./lit-html-s0HVm7S4.js";const d={title:"Templates/palStorytale"},e={args:{content:"A small caterpillar was floating in a river and could not reach the shore. It tried many times but the water was too strong. A bird sitting on a tree saw the caterpillar in trouble. The bird dropped a leaf into the river and the caterpillar climbed on it to reach the shore. The caterpillar thanked the bird for helping it.",highlightWord:!0,audioURL:"https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/palAudio/palStoyTaleAudio.mp3"},render:t=>{const o=s(t);return l`<lido-home .xmlData="${o}"></lido-home>`}};function s(t){return`<main>
    <lido-container disable-speak="true" highlight-word-by-word="${t.highlightWord}"  show-prev-button="false" show-next-button="true" id="lido-container" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/palStory/bgImage.png" height="1600px" width="900px" value="mainContainer4" objective="" aria-label="" x="0" y="0" z="0" visible="true" audio="" onTouch="" onCorrect="" onEntry="" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" show-check="false" is-continue-on-correct="true">
        <lido-cell layout="row" id="cell1" visible="true" margin="99px 164px 0px 0px"  value="cell1" width="landscape.87%,portrait.86%" height="landscape.76%,portrait.80%" x="50px" y="50px" bg-color="transparent"  onEntry="" >
            ...
            <lido-text id="text1" tab-index="1" audio="${t.audioURL}"  value="text1" visible="true" width="landscape.100%,portrait.90%" height="100%" bg-color="#FFF5BB" font-family="Baloo Bhai 2" font-size="60px" font-color="#000" string='${t.content}' onEntry="this.border='2px solid #FFB612'; this.fontWeight='600';this.padding='20px 28px'; this.boxShadow='unset'; this.border-radius='16px'; this.textAlign='start'; this.speak='true';">
            </lido-text>
        </lido-cell>
    ...
    </main>`}var a,r,i;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
...
}`,...(i=(r=e.parameters)==null?void 0:r.docs)==null?void 0:i.source}}};const h=["AmazingStories"];export{e as AmazingStories,h as __namedExportsOrder,d as default};
