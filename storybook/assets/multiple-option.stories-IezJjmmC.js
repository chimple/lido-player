        ...
        <lido-cell visible="true" layout="col" width="100%" height="100%" bg-color="transparent">
            ...
            <lido-cell layout="flex" visible="true" width="100%" height="landscape.30%, portrait.25%" bg-color="transparent" onEntry="this.justifyContent='center'; this.alignContent='center'; this.animation='topToPlace 0.5s linear';">
                <lido-image visible="true" is-slice="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/temp1/questionBg.png" bg-color="transparent" width="landscape.65%, portrait.70%" height="40%" onEntry="this.padding='20px';">
                    <lido-text id="textA" tab-index="2" value="{question.id}" visible="true" width="1000px" height="100px" onEntry="this.boxShadow='unset'; this.fontWeight='800';" string="${t.question}" font-family="'Baloo 2', serif" font-size="40px" font-color="black" bg-color="transparent" z="0" x="25px" y="20px" onTouch="question.speak='true';"></lido-text>
                </lido-image>
            </lido-cell>
            ...
            <lido-cell layout="flex" visible="true" width="100%" height="70%" bg-color="transparent" onEntry="this.justifyContent='center'; this.alignContent='center'; this.animation='bottomToPlace 1s linear';">
                <lido-cell visible="true" layout="landscape.row, portrait.wrap" width="landscape.70%, portrait.73%" height="landscape.50%, portrait.auto" bg-color="transpernt" gap="landscape.30px, portrait.55px" onEntry="">
                    <lido-cell visible="true" layout="col" width="landscape.25%, portrait.100%" type="click" value="${t.option1}" height="100%" onEntry="this.borderRadius='25px'; this.padding='0';" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" audio='${t.audio1}' onTouch="this.speak='true';">
                    ...
                    <lido-cell visible="true" layout="col" width="landscape.25%, portrait.100%" type="click" value="${t.option2}" height="100%" onEntry="this.borderRadius='25px'; this.padding='0';" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" audio='${t.audio2}' onTouch="this.speak='true';">
                    ...
                    <lido-cell visible="true" layout="col" width="landscape.25%, portrait.100%" type="click" value="${t.option3}" height="100%" onEntry="this.borderRadius='25px'; this.padding='0';" margin="landscape.0, portrait.20px 0 0 0" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" audio='${t.audio3}' onTouch="this.speak='true';">
                    ...
                    <lido-cell visible="true" layout="col" width="landscape.25%, portrait.100%" type="click" value="${t.option4}" height="100%" onEntry="this.borderRadius='25px'; this.padding='0';" margin="landscape.0, portrait.20px 0 0 0" onCorrect="this.border='8px solid green';" onInCorrect="this.border='8px solid red';" audio='${t.audio4}' onTouch="this.speak='true';">
                        ...
                        <lido-text visible="true" font-size="40px" font-color="black" string="Tig${t.option4}er" width="100%" bg-color="transparent" onEntry="this.fontWeight='bold';"></lido-text>
                    </lido-cell>
                </lido-cell>
            </lido-cell>
