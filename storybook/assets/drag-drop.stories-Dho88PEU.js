import"./lit-element-DByy2wOb.js";import{b as r}from"./lit-html-BGZAEiha.js";const d={title:"Templates/DragAndDrop",argTypes:{question:{control:"text"},option1:{control:"text"},option2:{control:"text"},option3:{control:"text"},option4:{control:"text"},correct1:{control:"text"},correct2:{control:"text"},correct3:{control:"text"},correct4:{control:"text"}}},e={args:{question:"Make it Alphabetical Order",option1:"BasketBall",option2:"Character",option3:"Dance",option4:"Apple",correct1:"Apple",correct2:"BasketBall",correct3:"Character",correct4:"Dance"},render:t=>{const s=p(t);return r`<lido-home .xmlData="${s}"></lido-home>`}};function p(t){return`<main>
            <lido-container id="lido-container" tab-index="1" value="mainContainer1" objective="${t.correct1},${t.correct2},${t.correct3},${t.correct4}" aria-label="" height="100vh" width="100vw" x="0" y="0" z="0" bg-color="#FFB742" visible="true" audio="background1.mp3" onTouch="" onCorrect="lido-avatar.avatarAnimate='Success'; this.sleep='2000';" onEntry="" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" show-check="false" is-continue-on-correct="true" after-drop="true">
                ...
                <lido-pos id="question" value="pos3" visible="true" width="840px" height="135px" x="landscape.370px, portrait.30px" y="100px"  bg-color="transparent" onEntry="this.animation='topToPlace 0.5s linear';">
                    ...
                    <lido-text id="textA" width="800px" height="100px" tab-index="2" value="{question.id}" visible="true" string="${t.question}" font-family="'Baloo 2', serif" font-color="black" font-size="40px" bg-color="transparent" onEntry="this.boxShadow='unset'; this.fontWeight='800';" y="20px" x="25px">
                    </lido-text>
                </lido-pos>
                <!-- Drop Elements -->
                ...
                <lido-pos id="pos6" value="pos6" visible="true" width="landscape.1600px, portrait.900px" height="150px" bg-color="transparent" x="0" y="landscape.700px, portrait.1260px" z="1" onEntry="this.animation='bottomToPlace 1s linear';">
                    <lido-row id="row2" value="row2" display="landscape.flex, portrait.grid" visible="true" height="landscape.150px, portrait.240px" width="landscape.auto, portrait.597px" min-length="2" max-length="6" child-elements-length="4" x="50%" y="50%" onEntry="this.gap='30px'; this.transform='translate(-50%, -50%)';">
                        <lido-text id="option1" value="${t.option1}" tab-index="6" flexible-width="false" visible="true" border-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/temp2/dragElementBg.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="150px" height="100px" string="${t.option1}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" type="drag">
                        </lido-text>
                        <lido-text id="option2" value="${t.option2}" tab-index="7" flexible-width="false" visible="true" border-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/temp2/dragElementBg.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="150px" height="100px" string="${t.option2}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" type="drag">
                        </lido-text>
                        <lido-text id="option3" value="${t.option3}" tab-index="8" flexible-width="false" visible="true" border-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/temp2/dragElementBg.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="150px" height="100px" string="${t.option3}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" type="drag">
                        </lido-text>
                        <lido-text id="option3" value="${t.option4}" tab-index="9" flexible-width="false" visible="true" border-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/temp2/dragElementBg.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="150px" height="100px" string="${t.option4}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" type="drag">
                        </lido-text>
                    </lido-row>
                </lido-pos>
            </lido-container>
