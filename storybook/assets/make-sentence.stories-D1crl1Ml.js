import"./lit-element-DByy2wOb.js";import{b as s}from"./lit-html-BGZAEiha.js";const h={title:"Templates/MakeSentence",argTypes:{options:{control:"object"},Answer:{control:"text"}}},i={args:{options:["postponed","has","The","game","been","indefinitely"],Answer:"The game has been indefinitely postponed"},render:e=>{const o=l(e);return s`<lido-home .xmlData="${o}"></lido-home>`}};function l(e){return`<main>
