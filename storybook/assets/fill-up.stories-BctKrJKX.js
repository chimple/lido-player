   ...
   <main>
        ...
        <lido-cell layout="col" visible="true" width="100%" height="100%" bg-color="transparent">
            ...
            <lido-cell visible="true" margin="landscape.12px 0px -17px 0px, portrait.-76px 0px 40px;">
                <lido-text id="heading" tab-index="2" visible="true" string="${t.heading}" font-family="'Baloo Bhai 2'" fontColor="black" font-size="landscape.36px, portrait.40px" bg-color="transparent" onEntry=" this.fontWeight='700';" margin="landscape.32px 0px 4px 0px,portrait.35px 0px 74px">
                </lido-text>
            </lido-cell>
            ...
            <lido-cell layout="landscape.row, portrait.col" visible="true" width="landscape.75%, portrait.76%" height="landscape.57%, portrait.73%" bg-color="white" onEntry="this.borderRadius='10px'; this.padding='8px';" margin="landscape.0 , portrait. -164px 0px -308px">
                ...
                <lido-cell layout="flex" visible="true" height="landscape.100%,portrait.50%" width="landscape.50%, portrait.90%" onEntry="this.align-content='center'; this.gap='32px';this.display='ruby';" margin="landscape.73px 40px 0px 0px, portrait.21px 0px 0px 0px">
                    <lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${t.text1}" bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px'; "></lido-text>
                    <lido-text id="drop1"   disable-edit="true" tab-index="3" visible="true" width="164px" height="landscape.73px,portrait.77px" value="${t.answer1}"  type="drop" is-allow-only-one-drop="true" onEntry="this.border-radius='10px';this.box-shoadow=''; this.margin-right='18px';" ></lido-text>
                    <lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${t.text2}" bg-color="transparent" onEntry="this.display='inline';this.boxShadow='0 0 0'; this.padding='0px 18px 0px 0px';"></lido-text>
                    <lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${t.text3}" bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px';"></lido-text>
                    <lido-text id="drop2"    disable-edit="true" tab-index="4" visible="true" width="164px" height="landscape.73px,portrait.77px" value="${t.answer2}" type="drop" is-allow-only-one-drop="true" onEntry="this.border-radius='10px'; this.margin-right='18px'; " ></lido-text>
                    <lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${t.text4}" bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px'; "></lido-text>
                    <lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${t.text5}" bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px'; "></lido-text>
                    <lido-text id="drop3"   disable-edit="true" tab-index="5" visible="true" width="164px" height="landscape.73px,portrait.77px" value="${t.answer3}" type="drop" is-allow-only-one-drop="true" onEntry="this.border-radius='10px'; this.margin-right='18px';  "></lido-text>
                    <lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${t.text6}" bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px';"></lido-text>
                    <lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${t.text7} " bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px'; "></lido-text>
                    <lido-text id="drop4"    disable-edit="true" tab-index="6" visible="true" width="164px" height="landscape.73px,portrait.77px" value="${t.answer4}" type="drop" is-allow-only-one-drop="true" onEntry="this.border-radius='10px'; this.margin-right='18px';" ></lido-text>
                    <lido-text font-family="'Baloo Bhai 2'" visible="true" font-size="40px" string="${t.text8}" bg-color="transparent" onEntry=" this.fontWeight='400';this.display='inline'; this.padding='0px 18px 0px 0px'; "></lido-text>
