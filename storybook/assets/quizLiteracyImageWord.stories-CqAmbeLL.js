import"./lit-element-BxxbMms4.js";import{x as s}from"./lit-html-DLYuhZ0i.js";const h={title:"Templates/quizLiteracyImageWord",argTypes:{image:{control:"file"}}},a={args:{option1:"Elephant",option2:"Fish",option3:"Egg",option4:"Nest",answers:"Elephant",image:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/LetterPair/Cat.png"]},render:t=>{const e=l(t);return s`<lido-home .xmlData="${e}"></lido-home>`}};function l(t){let e=1;const n=Array.isArray(t.answers)?t.answers:[t.answers];return`<main>
  ...
  onEntry="this.align-items='center'; this.justify-content='center';">
   ...
   ${n.filter(Boolean).map(i=>i?i.startsWith("http")||/\.(png|jpg|jpeg|gif|webp|svg)$/i.test(i)?`
        ...
        <lido-text visible="true" id="answer${e}"  
          ...
          string="${i}" margin="landscape.0px,portrait.-131px 0px 0px 0px" value="${i}" type="text"
  ...
  </main>`}var o,r,p;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    option1: "Elephant",
    option2: "Fish",
    option3: "Egg",
...
}`,...(p=(r=a.parameters)==null?void 0:r.docs)==null?void 0:p.source}}};const g=["quizLiteracyImageWord"];export{g as __namedExportsOrder,h as default,a as quizLiteracyImageWord};
