import"./lit-element-DRlmAcsz.js";import{b as n}from"./lit-html-s0HVm7S4.js";const s={title:"Templates/create-sentence",argTypes:{heading:{control:"text"},headingAudio:{control:{type:"file",accept:".mp3, .wav, .ogg, audio/*"}},questionImg:{control:"file"},option1:{control:"text"},option1Audio:{control:{type:"file",accept:".mp3, .wav, .ogg, audio/*"}},option2:{control:"text"},option2Audio:{control:{type:"file",accept:".mp3, .wav, .ogg, audio/*"}},option3:{control:"text"},option3Audio:{control:{type:"file",accept:".mp3, .wav, .ogg, audio/*"}},option4:{control:"text"},option4Audio:{control:{type:"file",accept:".mp3, .wav, .ogg, audio/*"}},option5:{control:"text"},option5Audio:{control:{type:"file",accept:".mp3, .wav, .ogg, audio/*"}},option6:{control:"text"},option6Audio:{control:{type:"file",accept:".mp3, .wav, .ogg, audio/*"}},option7:{control:"text"},option7Audio:{control:{type:"file",accept:".mp3, .wav, .ogg, audio/*"}},option8:{control:"text"},option8Audio:{control:{type:"file",accept:".mp3, .wav, .ogg, audio/*"}},correct1:{control:"text"},correct2:{control:"text"},correct3:{control:"text"},correct4:{control:"text"},correct5:{control:"text"},correct6:{control:"text"},correct7:{control:"text"},correct8:{control:"text"}}},o={args:{heading:"Who is the father of the nation?",headingAudio:"",questionImg:["https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/create%20sentence/Mahatma-Gandhi.jpg"],option1:"called",option1Audio:"",option2:"the",option2Audio:"",option3:"Mahatma",option3Audio:"",option4:"is",option4Audio:"",option5:"of",option5Audio:"",option6:"Father",option6Audio:"",option7:"India",option7Audio:"",option8:"Gandhi",option8Audio:"",correct1:"Mahatma",correct2:"Gandhi",correct3:"is",correct4:"called",correct5:"the",correct6:"Father",correct7:"of",correct8:"India"},render:t=>{const a=p(t);return n`<lido-home .xmlData="${a}"></lido-home>`}};function p(t){return`<main>
        ...
        <lido-cell id="row1" layout="col" height="100%" width="100%" visible="true" bg-Color="transparent">
            ...
            <lido-cell id="col" layout="col" disable-edit="true" value="pos" aria-hidden="true" x="0" y="0" z="0" bg-color="transparent" type="" visible="true" audio="" onTouch="" onCorrect="" width="100%" height="100%" onEntry="">
                ...
                <lido-cell layout="landscape.flex,portrait.wrap" delay-visible="2650" visible="true" width="landscape.86%, portrait.88%" y="landscape.65%, portrait.62%" x="landscape.4%,portrait.0px" z="2" onEntry="this.gridTemplateColumns = 'repeat(4, 1fr)';  this.gridTemplateRows = 'repeat(2, 1fr)';this.position='relative';this.gap='40px';">
                    ...
                    <lido-text id="option1"  audio="${t.option1Audio}" value="${t.option1}" tab-index="10"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800';  " width="auto" height="84px" string="${t.option1}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                    <lido-text id="option2"  audio="${t.option2Audio}" value="${t.option2}" tab-index="11"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; " width="auto" height="84px" string="${t.option2}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">

                    </lido-text>
                    <lido-text id="option3"  audio="${t.option3Audio}" value="${t.option3}" tab-index="12"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; " width="auto" height="84px" string="${t.option3}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                    <lido-text id="option4"  audio="${t.option4Audio}" value="${t.option4}" tab-index="13"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; " width="auto" height="84px" string="${t.option4}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                    <lido-text id="option5"  audio="${t.option5Audio}" value="${t.option5}" tab-index="14"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; " width="auto" height="84px" string="${t.option5}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                    <lido-text id="option6"  audio="${t.option6Audio}" value="${t.option6}" tab-index="15"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800';" width="auto" height="84px" string="${t.option6}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                    <lido-text id="option7"  audio="${t.option7Audio}" value="${t.option7}" tab-index="16"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; " width="auto" height="84px" string="${t.option7}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
                    </lido-text>
                    <lido-text id="option8"  audio="${t.option8Audio}" value="${t.option8}" tab-index="17"  visible="true" bg-color="#FCF3B1" onEntry="this.padding='0px 40px';this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; " width="auto" height="84px" string="${t.option8}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag">
    ...
    </main>`}var i,e,r;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
...
}`,...(r=(e=o.parameters)==null?void 0:e.docs)==null?void 0:r.source}}};const c=["CreateSentence"];export{o as CreateSentence,c as __namedExportsOrder,s as default};
