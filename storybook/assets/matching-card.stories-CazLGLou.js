import"./lit-element-DRlmAcsz.js";import{b as p}from"./lit-html-s0HVm7S4.js";const c={title:"Templates/matchingCard",argTypes:{answer:{control:"text"},option1:{control:"text"},option2:{control:"text"},option3:{control:"text"},isAllowOnlyCorrect:{control:"boolean"}}},a={args:{answer:"correct",option1:"incorrect",option2:"correct",option3:"incorrect",isAllowOnlyCorrect:!0},render:t=>{const o=n(t);return p`<lido-home .xmlData="${o}"></lido-home>`}};function n(t){return`
    <main>
