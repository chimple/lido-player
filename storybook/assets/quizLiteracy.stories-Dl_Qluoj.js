  ...
  ${t.text&&t.text.length>0?`<lido-text visible="true" id="answer${e}"  
        ...
        <lido-cell layout="flex" visible="true"  margin="landscape.0px,portrait.-424px 0px 407px 0px" width="landscape.100%,portrait.77%" height="216px" bg-Color="transparent" onEntry="this.align-items='center'; this.justify-content='center'; this.gap='40px';">
            ...
            <lido-text visible="true" audio=""  show-speak-icon="true" id="drag${e}" tab-index="${e++}" font-size="140px" border-radius="12px" font-color="black" height="205px" width="auto" string="${t.option1}" value="${t.option1}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
              ...
              <lido-text visible="true" audio=""  show-speak-icon="true" id="drag${e}" tab-index="${e++}" font-size="140px" border-radius="12px" font-color="black" height="205px" width="auto" string="${t.option2}" value="${t.option2}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
              <lido-text visible="true" audio=""  show-speak-icon="true" id="drag${e}" tab-index="${e++}" font-size="140px" border-radius="12px" font-color="black" height="205px" width="auto" string="${t.option3}" value="${t.option3}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
              <lido-text visible="true" audio=""  show-speak-icon="true" id="drag${e}" tab-index="${e++}" font-size="140px" border-radius="12px" font-color="black" height="205px" width="auto" string="${t.option4}" value="${t.option4}" type="click" onEntry="this.font-weight='500';this.padding='0px 64px 0px 64px';">
            </lido-text>
