import"./lit-element-DByy2wOb.js";import{b as n}from"./lit-html-BGZAEiha.js";const d={title:"Templates/quizLiteracy",argTypes:{option1:{control:"text"},option2:{control:"text"},option3:{control:"text"},option4:{control:"text"},text:{control:"text"},answers:{control:"text"}}},i={args:{option1:"Hippopotamus",option2:"Grandmother",option3:"Elephant",option4:"Sunflower",text:"Elephant",answers:"Elephant",image:"https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/template/audioIcon.png"},render:t=>{const e=p(t);return n`<lido-home .xmlData="${e}"></lido-home>`}};function p(t){let e=1;return`<main>
