    ...
    <lido-container id="lido-container" visible="true" objective="${e.cells.filter(t=>t.type==="drop").map(t=>t.value.toLowerCase()).join(",")}" 
      ...
      <lido-cell visible="true" layout="col" width="100%" height="100%" bg-color="transparent">
        ...
        <lido-keyboard visible="true" bg-color="#5F1A29" font-color="white" font-size="80px" 
          keys="${e.buttons}" width="90%" height="landscape.45%,portrait.35%" 
