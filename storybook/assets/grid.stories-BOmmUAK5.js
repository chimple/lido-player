                ...
                <lido-cell layout="landscape.row, portrait.col" bg-color="transparent" visible="true" width="100%" height="100%">
                    ...
                    <lido-cell layout="col" bg-color="transparent" visible="true" width="100%" height="100%">
                        <lido-cell layout="row" visible="true" width="75%" height="100%" bg-color="transparent" x="0px" y="0px" margin="landscape.0px 0px 0px 25%, portrait.0px 0px 0px 25%" z="1">
                            ...
                            <lido-image is-slice="true" id="option2" value="ug" show-speak-icon="true" audio="" tab-index="2" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/grass_question_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.25%, portrait.22%" height="landscape.70%, portrait.75%" font-size="36px" z="0">
                            ...
                            <lido-image is-slice="true" id="option3" value="ad" show-speak-icon="true" audio="" tab-index="3" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/grass_question_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.25%, portrait.22%" height="landscape.70%, portrait.75%" font-size="36px" z="0">
                        ...
                        <lido-cell layout="row" visible="true" width="100%" height="100%" bg-color="transparent">
                            <lido-image is-slice="true" tab-index="4" id="option4" show-speak-icon="true" audio="" value="basket" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/grass_question_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.20%, portrait.18%" height="landscape.70%, portrait.75%" font-size="36px" z="0">
                        ...
                        <lido-cell layout="row" visible="true" width="100%" height="100%" bg-color="transparent">
                            <lido-image is-slice="true" id="option8" value="basket" show-speak-icon="true" audio="" tab-index="8" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/grass_question_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.20%, portrait.18%" height="landscape.70%, portrait.75%" font-size="36px" z="0">
                        ...
                        <lido-cell layout="row" visible="true" width="100%" height="100%" bg-color="transparent">
                            <lido-image is-slice="true" id="option12" value="basket" show-speak-icon="true" audio="" tab-index="12" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/grass_question_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.20%, portrait.18%" height="landscape.70%, portrait.75%" font-size="36px" z="0">
                    ...
                    <lido-cell layout="landscape.col, portrait.row" visible="true" width="landscape.25%, portrait.75%" height="landscape.100%, portrait.30%" bg-color="transparent" x="0px" y="0px" margin="landscape.54% 0px 0px 0px, portrait.0px 0px 0px 37%" z="1" onEntry="this.justifyContent='unset';">
                        <lido-image tab-index="16" is-slice="true" type="drag" show-speak-icon="true" audio="" id="option16" value="${t.option1}" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/blue_alphabet_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.120px, portrait.120px" height="landscape.120px, portrait.120px" font-size="36px" z="0" margin="landscape.0px 0px 90px 0px, portrait.0px 82px 0px 0px">
                            <lido-text visible="true" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="landscape.100px, portrait.120px" height="landscape.120px, portrait.100px" string="${t.option1}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" onTouch="this.speak='true';">
                            </lido-text>
                        </lido-image>
                        <lido-image tab-index="17" is-slice="true" type="drag" show-speak-icon="true" audio="" id="option17" value="${t.option2}" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/blue_alphabet_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.120px, portrait.120px" height="landscape.120px, portrait.120px" font-size="36px" z="0" margin="landscape.0px 0px 90px 0px, portrait.0px 82px 0px 0px">
                            <lido-text visible="true" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="landscape.100px, portrait.120px" height="landscape.120px, portrait.100px" string="${t.option2}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" onTouch="this.speak='true';">
                            </lido-text>
                        </lido-image>
                        <lido-image tab-index="18" is-slice="true" type="drag" show-speak-icon="true" audio="" id="option18" value="${t.option3}" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/blue_alphabet_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.120px, portrait.120px" height="landscape.120px, portrait.120px" font-size="36px" z="0" margin="landscape.0px 0px 90px 0px, portrait.0px 82px 0px 0px">
                            <lido-text visible="true" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="landscape.100px, portrait.120px" height="landscape.120px, portrait.100px" string="${t.option3}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" onTouch="this.speak='true';">
                            </lido-text>
                        </lido-image>

                        <!--hidden drags -->
                        <lido-image is-slice="true" type="drag" show-speak-icon="true" tab-index="19" audio="" id="option19" value="${t.option4}" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/blue_alphabet_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.120px, portrait.120px" height="landscape.120px, portrait.120px" font-size="36px" z="0" margin="landscape.0px 0px 90px 0px, portrait.0px 82px 0px 0px">
                            <lido-text visible="true" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="landscape.100px, portrait.120px" height="landscape.120px, portrait.100px" string="${t.option4}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" onTouch="this.speak='true';">
                            </lido-text>
                        </lido-image>
                        <lido-image is-slice="true" type="drag" show-speak-icon="true" tab-index="20" audio="" id="option20" value="${t.option5}" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/blue_alphabet_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.120px, portrait.120px" height="landscape.120px, portrait.120px" font-size="36px" z="0" margin="landscape.0px 0px 90px 0px, portrait.0px 82px 0px 0px">
                            <lido-text visible="true" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="landscape.100px, portrait.120px" height="landscape.120px, portrait.100px" string="${t.option5}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" onTouch="this.speak='true';">
                            </lido-text>
                        </lido-image>
                        <lido-image is-slice="true" type="drag" show-speak-icon="true" tab-index="21" audio="" id="option21" value="${t.option6}" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/blue_alphabet_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.120px, portrait.120px" height="landscape.120px, portrait.120px" font-size="36px" z="0" margin="landscape.0px 0px 90px 0px, portrait.0px 82px 0px 0px">
                            <lido-text visible="true" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="landscape.100px, portrait.120px" height="landscape.120px, portrait.100px" string="${t.option6}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" onTouch="this.speak='true';">
                            </lido-text>
                        </lido-image>

                        <lido-image is-slice="true" type="drag" show-speak-icon="true" tab-index="22" audio="" id="option22" value="${t.option7}" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/blue_alphabet_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.120px, portrait.120px" height="landscape.120px, portrait.120px" font-size="36px" z="0" margin="landscape.0px 0px 90px 0px, portrait.0px 82px 0px 0px">
                            <lido-text visible="true" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="landscape.100px, portrait.120px" height="landscape.120px, portrait.100px" string="${t.option7}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" onTouch="this.speak='true';">
                            </lido-text>
                        </lido-image>
                        <lido-image is-slice="true" type="drag" show-speak-icon="true" tab-index="23" audio="" id="option23" value="${t.option8}" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/blue_alphabet_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.120px, portrait.120px" height="landscape.120px, portrait.120px" font-size="36px" z="0" margin="landscape.0px 0px 90px 0px, portrait.0px 82px 0px 0px">
                            <lido-text visible="true" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="landscape.100px, portrait.120px" height="landscape.120px, portrait.100px" string="${t.option8}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" onTouch="this.speak='true';">
                            </lido-text>
                        </lido-image>
                        <lido-image is-slice="true" type="drag" show-speak-icon="true" tab-index="24" audio="" id="option24" value="${t.option9}" visible="true" src="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/grid/blue_alphabet_wordmatrix.png" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset';" width="landscape.120px, portrait.120px" height="landscape.120px, portrait.120px" font-size="36px" z="0" margin="landscape.0px 0px 90px 0px, portrait.0px 82px 0px 0px">
                            <lido-text visible="true" bg-color="transparent" onEntry="this.borderRadius='unset'; this.boxShadow='unset'; this.fontWeight='800';" width="landscape.100px, portrait.120px" height="landscape.120px, portrait.100px" string="${t.option9}" font-color="black" font-family="'Baloo 2', serif" font-size="36px" z="0" onTouch="this.speak='true';">
                            </lido-text>
                        </lido-image>
