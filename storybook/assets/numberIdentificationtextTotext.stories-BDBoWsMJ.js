import"./lit-element-DByy2wOb.js";import{b as n}from"./lit-html-BGZAEiha.js";const c={title:"Templates/numberIdentificationtextTotext",argTypes:{option1:{control:"text"},option2:{control:"text"},option3:{control:"text"},option4:{control:"text"},question:{control:"text"},answer:{control:"text"},PracticeMode:{control:"boolean"}}},e={args:{PracticeMode:!1,option1:"333",option2:"256",option3:"777",option4:"234",question:"SEVEN HUNDRED AND SEVENTY SEVEN",answer:"777"},render:t=>{const r=l(t);return n`<lido-home .xmlData="${r}"></lido-home>`}};function l(t){return`<main>
