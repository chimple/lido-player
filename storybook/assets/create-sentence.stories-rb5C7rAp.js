        ...
        <lido-cell id="row1" layout="row" height="100%" width="100%" visible="true">
            ...
            <lido-cell id="col" layout="col" disable-edit="true" value="pos" aria-hidden="true" x="0" y="0" z="0" bg-color="transparent" type="" visible="true" audio="" onTouch="" onCorrect="" width="100%" height="100%" onEntry="">
                ...
                <lido-cell layout="row" visible="true" width="landscape.70%, portrait.130%" y="landscape.40%, portrait.42%" x="landscape.20%,portrait.25%" z="2" onEntry="this.position='relative'">
                    <lido-text id="option1" value="${t.option1}" tab-index="5" flexible-width="false" visible="true" bg-color="#6DC1ED" onEntry="this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; this.animation='bottomToPlace 2.6s linear'; this.color='white';" width="150px" height="90px" string="${t.option1}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag"></lido-text>
                    <lido-text id="option2" value="${t.option2}" tab-index="6" flexible-width="false" visible="true" bg-color="#6DC1ED" onEntry="this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; this.animation='bottomToPlace 3s linear'; this.color='white';" width="150px" height="90px" string="${t.option2}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag"></lido-text>
                    <lido-text id="option3" value="${t.option3}" tab-index="7" flexible-width="false" visible="true" bg-color="#6DC1ED" onEntry="this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; this.animation='bottomToPlace 3.5s linear'; this.color='white';" width="150px" height="90px" string="${t.option3}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag"></lido-text>
                    <lido-text id="option4" value="${t.option4}" tab-index="8" flexible-width="false" visible="true" bg-color="#6DC1ED" onEntry="this.borderRadius='25px'; this.boxShadow='unset'; this.fontWeight='800'; this.animation='bottomToPlace 4s linear'; this.color='white';" width="150px" height="90px" string="${t.option4}" font-family="'Baloo 2', serif" font-size="24px" z="2" type="drag"></lido-text>
                </lido-cell>
            </lido-cell>
            <!-- avatar -->
...
}`,...(r=(o=e.parameters)==null?void 0:o.docs)==null?void 0:r.source}}};const c=["CreateSentence"];export{e as CreateSentence,c as __namedExportsOrder,p as default};
