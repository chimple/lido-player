import"./lit-element-DByy2wOb.js";import{b as h}from"./lit-html-BGZAEiha.js";const y={title:"Templates/rowBlock",argTypes:{options:{control:"object"},answers:{control:"object"},isAllowOnlyCorrect:{control:"boolean"},isContinueOnCorrect:{control:"boolean"},colors:{control:"object",description:"Array of colors for numbers",defaultValue:["#F34D08","#81C127","#FFC805","#F55376","#5D44BD"]}}},i={args:{numbers:["970","971","972","973","@974","975","976","977","@978","979","980","981","982","@983","984","985","986","@987","988","989","990","991","992","993","@994","995","996","997","@998","999"],answers:["974","978","983","987","994","998"],dragColors:["#CF1565","#AD3184","#F55376","#81C127","#5D44BD"],isAllowOnlyCorrect:!0,isContinueOnCorrect:!0,numColors:["#FFE99B","#FBCAB5"]},render:e=>{const t=m(e);return h`<lido-home .xmlData="${t}"></lido-home>`}};function m(e){let t=1;const{answers:l=[],numbers:g=[],isAllowOnlyCorrect:d=!0,isContinueOnCorrect:x=!0}=e,u=l.map((r,p)=>{const a=e.dragColors,o=a[Math.floor(Math.random()*a.length)];return`
            <lido-text visible="true" id="drag${t}" tab-index="${t++}" width="140px" height="86px" value="${r}" string="${r}" font-color="white" font-size="76px" font-family="Baloo Bhai 2" bg-color="${o}" border-radius="8px" onEntry="this.border='5px solid ${o}'; this.font-weight='500'; this.sleep='100';this.animation='rightToPlace 3s linear';" type="drag" margin="${p%2==0?"landscape.196px 0px 0px -52px":"landscape.-56px 28px 0px -60px"}, portrait.0px 0px 0px 0px" isAllowOnlyCorrect="true" onTouch="this.speak='true';" onCorrect="this.speak='true';" ></lido-text>
      `}).join("");return`
<main>

    <lido-container id="lido-container" visible="true" objective="${l.join(",")}" onEntry="audio12.speak='true';"
        onCorrect="lido-avatar.avatarAnimate='Success';  sentenceText.speak='true'; this.sleep='2000';" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='2000';" is-continue-on-correct="${x}" bg-color="transparent" bg-image="https://aeakbcdznktpsbrfsgys.supabase.co/storage/v1/object/public/template-assets/background-images/Row%20blocks.png" custom-style= ".dropping {
        border: 5px dashed #2C3836 !important;
        background-color: #6D8C87 !important;
        }" is-allow-only-correct="${d}">

        <!-- Audio -->
        <lido-text visible="false" id="audio12" tab-index="${t++}" onEntry="this.display='none';" string="Drag the missing number to its correct place and complete the number puzzle."></lido-text>
        ...
        <lido-cell visible="true" layout="landscape.col, portrait.row" width="landscape.98%, portrait.860px" height="landscape.712px,portrait.1032px" padding="landscape.20px 42px, portrait.60px 10px" bg-Color="#234838" margin="landscape.90px 0px 0px 0px, portrait.-136px 0px 0px 0px" onEntry="this.animation='topToPlace 1s linear';" border-radius="10px">
            <lido-cell id="numberBlocks" visible="true" audio="" width="lanscape.102%, portrait.55%" height="landscape.40%, portrait.100%" layout="landscape.col, portrait.row" bg-color="transparent" gap="landscape.10px, portrait.20px" margin="landscape.16px -46px 0px 0px, portrait.0px 0px 0px 0px" padding="landscape.0px 0px 0px 0px, portrait.0px 0px 0px 30px">
                ...
                <lido-cell bg-color="transparent" height="landscape.32%, portrait.102%" width="landscape.103%, portrait.33%" 
                    ...
                    ${e.numbers.map((r,p)=>{const a=e.numColors,o=r.substring(1);return r.startsWith("@")?`
                    <lido-text visible="true" class="dropping" id="drop${t}" tab-index="${t++}" width="138px" height="86px" value="${o}" string="" font-color="#182A4F" font-size="76px" font-family="Baloo Bhai 2" bg-color="#6D8C87" border-radius="8px" onCorrect="lido-avatar.avatarAnimate='Success';" onInCorrect="lido-avatar.avatarAnimate='Fail'; this.sleep='1000';" onEntry="this.border='5px solid #2C3836'; this.speak='true';" type="drop" layout="row"></lido-text>
                    `:`
                    <lido-text visible="true" id="num${t}" tab-index="${t++}" width="140px" height="94px" value="${r}" string="${r}" font-color="#182A4F" font-size="76px" font-family="Baloo Bhai 2" bg-color="${p%2!==0?a[0]:a[1]}" border-radius="8px" onEntry="this.font-weight='500'" onTouch="this.speak='true';" margin="0px 1px 0px 0px"></lido-text>
                    `}).join("")}
                </lido-cell>
            </lido-cell>		
...
</main>`}var n,s,c;i.parameters={...i.parameters,docs:{...(n=i.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
...
}`,...(c=(s=i.parameters)==null?void 0:s.docs)==null?void 0:c.source}}};const v=["rowBlock"];export{v as __namedExportsOrder,y as default,i as rowBlock};
